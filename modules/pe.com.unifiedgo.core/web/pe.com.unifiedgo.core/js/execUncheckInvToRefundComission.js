...
OB.SCR.execUncheckInvToRefundComission = {
  execute: function (params, view) {
    ...
    for (i = 0; i < selection.length; i++) {
     ...
     isc.SCR_UncheckInvToRefundComissionPopup.create({
  ...
  execFunction: function (params, view) {
    params.actionHandler = 'pe.com.unifiedgo.core.UncheckInvToRefundComissionActionHandler';
    params.adTabId = view.activeView.tabId;
    OB.SCR.execUncheckInvToRefundComission.execute(params, view);
  }

};

isc.defineClass('SCR_UncheckInvToRefundComissionPopup', isc.OBPopup);

isc.SCR_UncheckInvToRefundComissionPopup.addProperties({
