...
public class PrintPreliquidation extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintPreliquidation.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.PRELIQUIDATION;
    // The prefix PRINTPRELIQUIDATION is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTPRELIQUIDATION";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsimImpSettlementID_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsimImpSettlementID");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_2",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_2");
  }
