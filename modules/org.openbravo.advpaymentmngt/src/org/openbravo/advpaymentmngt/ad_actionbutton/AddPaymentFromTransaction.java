...
public class AddPaymentFromTransaction extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      printGrid(response, request, vars, strFinancialAccountId, strBusinessPartnerId,
          ...
          strAmountTo, strTransactionDate);
      ...
      try {
        ...
        customerCredit = dao.getCustomerCredit(
            ...
            OBDal.getInstance().get(Organization.class, strOrgId), fa.getCurrency());
      } finally {
      ...
      /*
       * if (strDifferenceAction.equals("refund")) refundAmount = new
      ...
      try {
        ...
        if (selectedPaymentDetails.size() == 0 && !"".equals(strReceivedFromId)) {
          paymentBusinessPartner = OBDal.getInstance().get(BusinessPartner.class,
              strReceivedFromId);
        } else {
        ...
        payment = FIN_AddPayment.savePayment(null, payment, isReceipt, null, null, null, null, null,
            ...
            strDifferenceAction.equals("writeoff"), strDifferenceAction.equals("overpayment"),
        ...
        if (strAction.equals("PRP") || strAction.equals("PPP") || strAction.equals("PRD")
          ...
          /*
           * if (strDifferenceAction.equals("refund")) { Boolean newPayment =
           ...
           * exchangeRate); OBError auxMessage = FIN_AddPayment.processPayment(vars, this,
           * (strAction.equals("PRP") || strAction.equals("PPP")) ? "P" : "D", refundPayment); if
           * (newPayment) { final String strNewRefundPaymentMessage = Utility.parseTranslation(this,
           * vars, vars.getLanguage(), "@APRM_RefundPayment@" + ": " +
           * refundPayment.getDocumentNo()) + "."; message.setMessage(strNewRefundPaymentMessage +
           * " " + message.getMessage()); if
      ...
      final XmlDocument xmlDocument = xmlEngine
          .readXmlTemplate("org/openbravo/base/secureApp/PopUp_Close_Refresh").createXmlDocument();
  ...
  private void printGrid(HttpServletResponse response, HttpServletRequest request,
      ...
      String strAmountFrom, String strAmountTo, String transactionDate)
    ...
    if (!"".equals(strBusinessPartnerId) || !"".equals(strDocumentNo)
      ...
      filteredScheduledPaymentDetails = dao.getFilteredScheduledPaymentDetails(
          ...
          strAmountTo, FIN_Utility.getDate(transactionDate));
    }
    final FieldProvider[] data = FIN_AddPayment.getShownScheduledPaymentDetails(vars,
        ...
        displayDoubtfulDebtAmount(isReceipt), false, null, null, null, isReceipt);
