...
OB.SSH.execWBexportdata = {
  execute: function (params, view) {
    ...
    for (i = 0; i < selection.length; i++) {
     ...
     isc.SSH_WBexportdataPopup.create({
  ...
  execFunction: function (params, view) {
    params.actionHandler = 'pe.com.unifiedgo.shipping.WBexportdataActionHandler';
    params.adTabId = view.activeView.tabId;
    OB.SSH.execWBexportdata.execute(params, view);
  }

};

isc.defineClass('SSH_WBexportdataPopup', isc.OBPopup);

isc.SSH_WBexportdataPopup.addProperties({
