...
public class SWA_Physical_Inventory_DocType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strSWAPhysicalInventoryId = vars.getStringParameter("inpswaPhysicalInventoryId");
      String strDescription = vars.getStringParameter("inpdescription");
      String strTabId = vars.getStringParameter("inpTabId");

      try {
        printPage(response, vars, strDocTypeTarget, strDocType, docNo, strSWAPhysicalInventoryId,
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
      String strDocTypeTarget, String strDocType, String docNo, String strSWAPhysicalInventoryId,
    ...
    if (strDocTypeTarget.equals(""))
      ...
      resultado.append("var calloutName='SWA_Physical_Inventory_DocType';\n\n");
      ...
      SWAPhysicalInventoryDocTypeData[] data = null;

      if (!newDocNo && !"0".equals(strDocType)) {
        data = SWAPhysicalInventoryDocTypeData.select(this, strDocType);
      ...
      SWAPhysicalInventoryDocTypeData[] dataNew = SWAPhysicalInventoryDocTypeData.select(this,
          strDocTypeTarget);
      if (dataNew != null && dataNew.length > 0) {
        DocSubTypeSO = dataNew[0].docsubtypeso;
        if (DocSubTypeSO == null)
          DocSubTypeSO = "--";
        String strOldDocTypeTarget = SWAPhysicalInventoryDocTypeData.selectOldDocSubType(this,
            strSWAPhysicalInventoryId);
        if (!DocSubTypeSO.equals("OB") && strOldDocTypeTarget.equals("OB")) {
          String strOldDocNo = SWAPhysicalInventoryDocTypeData.selectOldDocNo(this,
              strSWAPhysicalInventoryId);
        ...
        if (dataNew[0].isdocnocontrolled.equals("Y")) {
          if (!newDocNo
              ...
              && !SWAPhysicalInventoryDocTypeData.selectOldDocTypeTargetId(this,
                  strSWAPhysicalInventoryId).equalsIgnoreCase(strDocTypeTarget))
            newDocNo = true;
          if (newDocNo) {
