...
public class PrintMovementCode extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintMovementCode.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.MOVEMENTCODE;
    // The prefix PrintMovementCode is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PrintMovementCode";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpswaMovementcodeId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpswaMovementcodeId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_23",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_23");
  }
