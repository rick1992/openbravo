...
public class SCO_A_Asset_Inv_Line_DocTypeRef extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    if (strInvoiceRefId != null && !strInvoiceRefId.equals("")) {
      ...
      if (invoice.getTransactionDocument().getId().equals(strDocTypeRefId) && invoice.getDocumentStatus().equals("CO")) {
