...
class GenerateAnaliticKardexData implements FieldProvider {
  static Logger log4j = Logger.getLogger(GenerateAnaliticKardexData.class);
  ...
  public static GenerateAnaliticKardexData[] selectOrganizacion(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String startDate, String endDate, String mWarehouseId) throws ServletException {

    return selectOrganizacion(connectionProvider, adOrgId, adClientId, mProductId, startDate, endDate, mWarehouseId, 0, 0);
  }

  public static GenerateAnaliticKardexData[] selectOrganizacion(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String startDate, String endDate, String mWarehouseId, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    ...
    try {
      ...
      while (continueResult && result.next()) {
        countRecord++;
        GenerateAnaliticKardexData objectGenerateAnaliticKardexData = new GenerateAnaliticKardexData();
        objectGenerateAnaliticKardexData.organizacion = UtilSql.getValue(result, "organizacion");
        objectGenerateAnaliticKardexData.ruc = UtilSql.getValue(result, "ruc");
        objectGenerateAnaliticKardexData.rownum = Long.toString(countRecord);
        objectGenerateAnaliticKardexData.InitRecordNumber = Integer.toString(firstRegister);

        vector.addElement(objectGenerateAnaliticKardexData);
    ...
    GenerateAnaliticKardexData objectGenerateAnaliticKardexData[] = new GenerateAnaliticKardexData[vector.size()];
    vector.copyInto(objectGenerateAnaliticKardexData);
    return (objectGenerateAnaliticKardexData);

  }

  public static GenerateAnaliticKardexData[] selectProducto(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String startDate, String endDate, String mWarehouseId) throws ServletException {

    return selectProducto(connectionProvider, adOrgId, adClientId, mProductId, startDate, endDate, mWarehouseId, 0, 0);
  }

  public static GenerateAnaliticKardexData[] selectProducto(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String startDate, String endDate, String mWarehouseId, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    ...
    try {
      ...
      while (continueResult && result.next()) {
        countRecord++;
        GenerateAnaliticKardexData objectGenerateAnaliticKardexData = new GenerateAnaliticKardexData();
        objectGenerateAnaliticKardexData.producto = UtilSql.getValue(result, "producto");
        objectGenerateAnaliticKardexData.rownum = Long.toString(countRecord);
        objectGenerateAnaliticKardexData.InitRecordNumber = Integer.toString(firstRegister);
  ...
  public static GenerateAnaliticKardexData[] selectAlmacen(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String startDate, String endDate, String mWarehouseId) throws ServletException {

    return selectAlmacen(connectionProvider, adOrgId, adClientId, mProductId, startDate, endDate, mWarehouseId, 0, 0);
  }

  public static GenerateAnaliticKardexData[] selectAlmacen(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String startDate, String endDate, String mWarehouseId, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    ...
    try {
      ...
      while (continueResult && result.next()) {
        countRecord++;
        GenerateAnaliticKardexData objectGenerateAnaliticKardexData = new GenerateAnaliticKardexData();
        objectGenerateAnaliticKardexData.almacen = UtilSql.getValue(result, "almacen");
        objectGenerateAnaliticKardexData.rownum = Long.toString(countRecord);
        objectGenerateAnaliticKardexData.InitRecordNumber = Integer.toString(firstRegister);
  ...
  public static GenerateAnaliticKardexData[] selectDataGeneral(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String docDate, String DateTo, String warehouse_id) throws ServletException {
    return selectDataGeneral(connectionProvider, adOrgId, adClientId, mProductId, docDate, null, 0, 0, DateTo, warehouse_id);
  }

  public static GenerateAnaliticKardexData[] selectDataGeneral(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String docDate, String numMonths, int firstRegister, int numberRegisters, String DateTo, String warehouse_id) throws ServletException {
    ...
    try {
      ...
      while (continueResult && result.next()) {
        countRecord++;
        GenerateAnaliticKardexData objectGenerateAnaliticKardexData = new GenerateAnaliticKardexData();
        objectGenerateAnaliticKardexData.warehousedata = UtilSql.getValue(result, "warehousedata");
        objectGenerateAnaliticKardexData.productdata = UtilSql.getValue(result, "productdata");
        objectGenerateAnaliticKardexData.rownum = Long.toString(countRecord);
        objectGenerateAnaliticKardexData.InitRecordNumber = Integer.toString(firstRegister);
  ...
  public static GenerateAnaliticKardexData[] selectKardexFinal(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String docDate, String DateTo, String warehouse_id) throws ServletException {
    return selectKardexFinal(connectionProvider, adOrgId, adClientId, mProductId, docDate, null, 0, 0, DateTo, warehouse_id);
  }

  public static GenerateAnaliticKardexData[] selectKardexFinal(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String docDate, String numMonths, int firstRegister, int numberRegisters, String DateTo, String warehouse_id) throws ServletException {
    ...
    try {
      ...
      while (continueResult && result.next()) {
        countRecord++;
        GenerateAnaliticKardexData objectGenerateAnaliticKardexData = new GenerateAnaliticKardexData();
        objectGenerateAnaliticKardexData.prdFinalID = UtilSql.getValue(result, "FINALID");
        objectGenerateAnaliticKardexData.movementqtyFinal = UtilSql.getValue(result, "QTYFINAL");
        objectGenerateAnaliticKardexData.rownum = Long.toString(countRecord);
        objectGenerateAnaliticKardexData.InitRecordNumber = Integer.toString(firstRegister);
  ...
  public static GenerateAnaliticKardexData[] selectKardexInitial(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String docDate, String DateTo, String warehouse_id) throws ServletException {
    return selectKardexInitial(connectionProvider, adOrgId, adClientId, mProductId, docDate, null, 0, 0, DateTo, warehouse_id);
  }

  public static GenerateAnaliticKardexData[] selectKardexInitial(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String docDate, String numMonths, int firstRegister, int numberRegisters, String DateTo, String warehouse_id) throws ServletException {
    ...
    try {
      ...
      while (continueResult && result.next()) {
        countRecord++;
        GenerateAnaliticKardexData objectGenerateAnaliticKardexData = new GenerateAnaliticKardexData();
        objectGenerateAnaliticKardexData.prdInitialID = UtilSql.getValue(result, "INITIALID");
        objectGenerateAnaliticKardexData.movementqtyInitial = UtilSql.getValue(result, "QTYINIT");
        objectGenerateAnaliticKardexData.rownum = Long.toString(countRecord);
        objectGenerateAnaliticKardexData.InitRecordNumber = Integer.toString(firstRegister);

        objectGenerateAnaliticKardexData.movementqty = UtilSql.getValue(result, "QTY");
        objectGenerateAnaliticKardexData.movementqtynegative = UtilSql.getValue(result, "QTYNEGATIVE");
        vector.addElement(objectGenerateAnaliticKardexData);
        if (countRecord >= numberRegisters && numberRegisters != 0) {
          continueResult = false;
        }
  ...
  public static GenerateAnaliticKardexData[] selectStockReservado(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String docDate, String DateTo, String warehouse_id) throws ServletException {
    return selectStockReservado(connectionProvider, adOrgId, adClientId, mProductId, docDate, null, 0, 0, DateTo, warehouse_id);
  }

  public static GenerateAnaliticKardexData[] selectStockReservado(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String docDate, String numMonths, int firstRegister, int numberRegisters, String DateTo, String warehouse_id) throws ServletException {
    ...
    try {
      ...
      while (continueResult && result.next()) {
        countRecord++;
        GenerateAnaliticKardexData objectGenerateAnaliticKardexData = new GenerateAnaliticKardexData();
        objectGenerateAnaliticKardexData.qtyreserved = UtilSql.getValue(result, "qtyreserved");
        objectGenerateAnaliticKardexData.rownum = Long.toString(countRecord);
        objectGenerateAnaliticKardexData.InitRecordNumber = Integer.toString(firstRegister);
  ...
  public static GenerateAnaliticKardexData[] selectKardex(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String docDate, String DateTo, String warehouse_id) throws ServletException {
    return selectKardex(connectionProvider, adOrgId, adClientId, mProductId, docDate, null, 0, 0, DateTo, warehouse_id);
  }

  public static GenerateAnaliticKardexData[] selectKardex(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String mProductId, String docDate, String numMonths, int firstRegister, int numberRegisters, String DateTo, String warehouse_id) throws ServletException {
    ...
    try {
      ...
      while (continueResult && result.next()) {
        countRecord++;
        GenerateAnaliticKardexData objectGenerateAnaliticKardexData = new GenerateAnaliticKardexData();
        objectGenerateAnaliticKardexData.prdID = UtilSql.getValue(result, "PRODUCTID");
        objectGenerateAnaliticKardexData.transactionID = UtilSql.getValue(result, "ID");
        objectGenerateAnaliticKardexData.movementDate = UtilSql.getDateValue(result, "MOVEMENTDATE");
        objectGenerateAnaliticKardexData.trxprocessmovement = UtilSql.getValue(result, "trxprocessmovement");
        objectGenerateAnaliticKardexData.movementHour = UtilSql.getValue(result, "MOVEMENTHOUR");
        objectGenerateAnaliticKardexData.warehousename = UtilSql.getValue(result, "WAREHOUSENAME");
        objectGenerateAnaliticKardexData.storagebin = UtilSql.getValue(result, "BIN");
        objectGenerateAnaliticKardexData.movementqty = UtilSql.getValue(result, "QTY");
        objectGenerateAnaliticKardexData.movementqtynegative = UtilSql.getValue(result, "QTYNEGATIVE");
        objectGenerateAnaliticKardexData.movementtype = UtilSql.getValue(result, "MOVEMENTTYPE");
        objectGenerateAnaliticKardexData.shipmentid = UtilSql.getValue(result, "SHIPMENT");
        objectGenerateAnaliticKardexData.shipmentline = UtilSql.getValue(result, "SHIPMENTLINE");
        objectGenerateAnaliticKardexData.inventoryid = UtilSql.getValue(result, "INVENTORY");
        objectGenerateAnaliticKardexData.inventoryline = UtilSql.getValue(result, "INVENTORYLINE");
        objectGenerateAnaliticKardexData.productionid = UtilSql.getValue(result, "PRODUCTION");
        objectGenerateAnaliticKardexData.productionline = UtilSql.getValue(result, "PRODUCTIONLINE");
        objectGenerateAnaliticKardexData.partner = UtilSql.getValue(result, "PARTNER");
        objectGenerateAnaliticKardexData.shipmentlinespecialDT = UtilSql.getValue(result, "SHIPMENTSDT");
        objectGenerateAnaliticKardexData.saldo = UtilSql.getValue(result, "saldo");
        objectGenerateAnaliticKardexData.mes = UtilSql.getValue(result, "mes");
        objectGenerateAnaliticKardexData.rownum = Long.toString(countRecord);
        objectGenerateAnaliticKardexData.InitRecordNumber = Integer.toString(firstRegister);
  ...
  public static GenerateAnaliticKardexData[] set() throws ServletException {
    GenerateAnaliticKardexData objectGenerateAnaliticKardexData[] = new GenerateAnaliticKardexData[1];
    objectGenerateAnaliticKardexData[0] = new GenerateAnaliticKardexData();
    objectGenerateAnaliticKardexData[0].productid = "";
    objectGenerateAnaliticKardexData[0].searchkey = "";
    objectGenerateAnaliticKardexData[0].internalcode = "";
    objectGenerateAnaliticKardexData[0].name = "";
    objectGenerateAnaliticKardexData[0].prdID = "";
    objectGenerateAnaliticKardexData[0].transactionID = "";
    objectGenerateAnaliticKardexData[0].movementDate = "";
    objectGenerateAnaliticKardexData[0].movementHour = "";
    objectGenerateAnaliticKardexData[0].warehousename = "";
    objectGenerateAnaliticKardexData[0].storagebin = "";
    objectGenerateAnaliticKardexData[0].movementqty = "";
    objectGenerateAnaliticKardexData[0].movementqtynegative = "";
    objectGenerateAnaliticKardexData[0].shipmentid = "";
    objectGenerateAnaliticKardexData[0].inventoryid = "";
    objectGenerateAnaliticKardexData[0].movementid = "";
    objectGenerateAnaliticKardexData[0].shipmentline = "";
    objectGenerateAnaliticKardexData[0].inventoryline = "";
    objectGenerateAnaliticKardexData[0].movementline = "";
    objectGenerateAnaliticKardexData[0].productionline = "";
    objectGenerateAnaliticKardexData[0].productionid = "";
    objectGenerateAnaliticKardexData[0].productionid = "";
    objectGenerateAnaliticKardexData[0].productdata = "";
    objectGenerateAnaliticKardexData[0].qtyreserved = "";
    objectGenerateAnaliticKardexData[0].shipmentlinespecialDT = "";
  ...
  public static GenerateAnaliticKardexData[] selectWarehouseDouble(ConnectionProvider connectionProvider, String adUserClient) throws ServletException {
    return selectWarehouseDouble(connectionProvider, adUserClient, 0, 0);
  }

  public static GenerateAnaliticKardexData[] selectWarehouseDouble(ConnectionProvider connectionProvider, String adUserClient, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    ...
    try {
      ...
      while (continueResult && result.next()) {
        countRecord++;
        GenerateAnaliticKardexData objectGenerateAnaliticKardexData = new GenerateAnaliticKardexData();
        objectGenerateAnaliticKardexData.padre = UtilSql.getValue(result, "padre");
        objectGenerateAnaliticKardexData.id = UtilSql.getValue(result, "id");
        objectGenerateAnaliticKardexData.name = UtilSql.getValue(result, "name");
        objectGenerateAnaliticKardexData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectGenerateAnaliticKardexData);
        if (countRecord >= numberRegisters && numberRegisters != 0) {
          continueResult = false;
