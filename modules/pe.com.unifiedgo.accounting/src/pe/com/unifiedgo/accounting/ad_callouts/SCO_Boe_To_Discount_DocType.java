...
public class SCO_Boe_To_Discount_DocType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strSCOBoeToDiscountId = vars.getStringParameter("inpscoBoeToDiscountId");
      String strDescription = vars.getStringParameter("inpdescription");
      String strTabId = vars.getStringParameter("inpTabId");

      try {
        printPage(response, vars, strDocTypeTarget, strDocType, docNo, strSCOBoeToDiscountId, strDescription, strTabId);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strDocTypeTarget, String strDocType, String docNo, String strSCOBoeToDiscountId, String strDescription, String strTabId) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
    ...
    if (strDocTypeTarget.equals(""))
      ...
      resultado.append("var calloutName='SCO_Boe_To_Discount_DocType';\n\n");
      ...
      SCOBoeToDiscountDocTypeData[] data = null;

      if (!newDocNo && !"0".equals(strDocType)) {
        data = SCOBoeToDiscountDocTypeData.select(this, strDocType);
      ...
      SCOBoeToDiscountDocTypeData[] dataNew = SCOBoeToDiscountDocTypeData.select(this, strDocTypeTarget);
      if (dataNew != null && dataNew.length > 0) {
        DocSubTypeSO = dataNew[0].docsubtypeso;
        if (DocSubTypeSO == null)
          DocSubTypeSO = "--";
        String strOldDocTypeTarget = SCOBoeToDiscountDocTypeData.selectOldDocSubType(this, strSCOBoeToDiscountId);
        if (!DocSubTypeSO.equals("OB") && strOldDocTypeTarget.equals("OB")) {
          String strOldDocNo = SCOBoeToDiscountDocTypeData.selectOldDocNo(this, strSCOBoeToDiscountId);
        ...
        if (dataNew[0].isdocnocontrolled.equals("Y")) {
          if (!newDocNo && !AD_Sequence_ID.equals(dataNew[0].adSequenceId) && !SCOBoeToDiscountDocTypeData.selectOldDocTypeTargetId(this, strSCOBoeToDiscountId).equalsIgnoreCase(strDocTypeTarget))
            newDocNo = true;
          if (newDocNo) {
