...
public class ReporteValidacionAsientosDescuadrados extends
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (vars.commandIn("DEFAULT")) {
			String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"ReporteValidacionAsientosDescuadrados|DateFrom", "");
			String strDateTo = vars.getGlobalVariable("inpDateTo",
					"ReporteValidacionAsientosDescuadrados|DateTo", "");
			String strOrg = vars.getGlobalVariable("inpOrg",
					"ReporteValidacionAsientosDescuadrados|Org", "0");
			String strRecord = vars.getGlobalVariable("inpRecord",
					"ReporteValidacionAsientosDescuadrados|Record", "");
			String strTable = vars.getGlobalVariable("inpTable",
					"ReporteValidacionAsientosDescuadrados|Table", "");
			...
			vars.setSessionValue(
					"ReporteValidacionAsientosDescuadrados.initRecordNumber",
					"0");
	...
	private void printPageDataSheet(HttpServletResponse response,
		...
		ReporteValidacionAsientosDescuadradosData[] data = null;
		String strPosition = "0";
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"ReporteValidacionAsientosDescuadrados", false, "", "",
...
//					false,
//					false,
//					"submitCommandForm('XLS', false, null, 'ReporteValidacionAsientosDescuadrados.xls', 'EXCEL');return false;");
			xmlDocument = xmlEngine
					.readXmlTemplate(
							"pe/com/unifiedgo/report/ad_reports/ReporteValidacionAsientosDescuadrados",
							discard).createXmlDocument();
			data = ReporteValidacionAsientosDescuadradosData.set("0");
			data[0].rownum = "0";
		}
		...
		try {
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"ReporteValidacionAsientosDescuadrados.html",
		...
		}
		{
			OBError myMessage = vars
					.getMessage("ReporteValidacionAsientosDescuadrados");
			vars.removeMessage("ReporteValidacionAsientosDescuadrados");
			if (myMessage != null) {
		...
		try {
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "AD_ORG_ID", "", "0C754881EAD94243A161111916E9B9C6", Utility.getContext(this,
							...
							"ReporteValidacionAsientosDescuadrados"),
		...
		xmlDocument.setParameter("paramPeriodosArray", Utility.arrayInfinitasEntradas("idperiodo;periodo;fechainicial;fechafinal;idorganizacion","arrPeriodos",
	  			ReporteValidacionAsientosDescuadradosData
				.select_periodos(this)));
		vars.setSessionValue(
				"ReporteValidacionAsientosDescuadrados|Record", strRecord);
		vars.setSessionValue(
				"ReporteValidacionAsientosDescuadrados|Table", strTable);
	...
	private void printPagePDF(HttpServletRequest request,HttpServletResponse response,
		...
		ArrayList<ReporteValidacionAsientosDescuadradosData> listData = new ArrayList<ReporteValidacionAsientosDescuadradosData>();

		String strTreeOrg = TreeData.getTreeOrg(this, vars.getClient());
		String strOrgFamily = getFamily(strTreeOrg, strOrg);

		data = ReporteValidacionAsientosDescuadradosData
				.select(this,strDateFrom, DateTimeData.nDaysAfter(
						this, strDateTo, "1"), Utility.getContext(this, vars,
						"#User_Client",
						"ReporteValidacionAsientosDescuadrados"),
						strOrgFamily, Utility.getContext(this, vars,
								"#User_Client",
								"ReporteValidacionAsientosDescuadrados"),
								strOrgFamily);
		...
		String strSubtitle = (Utility.messageBD(this, "LegalEntity",
				vars.getLanguage()) + ": ")
				+ ReporteValidacionAsientosDescuadradosData.selectCompany(
						this, vars.getClient())
				+ "\n"
				+ "RUC:"
				+ ReporteValidacionAsientosDescuadradosData.selectRucOrg(
						this, strOrg) + "\n";

		if (!("0".equals(strOrg)))
			strSubtitle += (Utility.messageBD(this, "OBUIAPP_Organization",
					vars.getLanguage()) + ": ")
					+ ReporteValidacionAsientosDescuadradosData.selectOrg(
							this, strOrg) + "\n";
		...
		if (vars.commandIn("PDF")) {
			strOutput = "pdf";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteValidacionAsientosDescuadrados.jrxml";
		} else {
			strOutput = "xls";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteValidacionAsientosDescuadradosExcel.jrxml";
		}

		HashMap<String, Object> parameters = new HashMap<String, Object>();
		// parameters.put("Subtitle", strSubtitle);
		parameters.put("Ruc", ReporteValidacionAsientosDescuadradosData
	...
	public String getServletInfo() {
		return "Servlet ReporteValidacionAsientosDescuadrados. This Servlet was made by Pablo Sarobe modified by everybody";
