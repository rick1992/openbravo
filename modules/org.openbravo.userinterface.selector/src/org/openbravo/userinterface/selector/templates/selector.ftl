...
/* always set the tabfix for the generated selectors */
    sc_${data.columnName}.getField().useclassicw_tabfix = true;
    sc_${data.columnName}.getField().addUnknownValues = false;
