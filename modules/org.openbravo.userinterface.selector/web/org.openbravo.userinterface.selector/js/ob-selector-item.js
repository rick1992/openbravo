...
isc.OBSelectorItem.addProperties({
  ...
  changed: function (form, item, newValue) {
    ...
    if (OB.Utilities.isUUID(newValue) || OB.Utilities.isUUIDMigration(newValue)) {
    ...
    var iden = this.mapDisplayToValue(identifier);
    if ( (OB.Utilities.isUUID(iden) ||  OB.Utilities.isUUIDMigration(iden)) && this._notUpdatingManually !== true) {
  ...
  mapValueToDisplay: function (value) {
    ...
    if (ret === value && value) {
      if (!this.valueMap) {
        ...
        this.valueMap[value] = '';
        return '';
      } else if (!this.valueMap[value] && (OB.Utilities.isUUID(value) || OB.Utilities.isUUIDMigration(value)) ) {
        return '';
      }
    }
    if (value && value !== '' && ret === '' && !(OB.Utilities.isUUID(value) || OB.Utilities.isUUIDMigration(value))   ) {
