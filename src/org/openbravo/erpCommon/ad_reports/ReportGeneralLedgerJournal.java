...
public class ReportGeneralLedgerJournal extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    System.out.println("command: " + vars.getCommand());
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strShowClosing = vars.getGlobalVariable("inpShowClosing", "ReportGeneralLedgerJournal|ShowClosing", "Y");
      String strShowReg = vars.getGlobalVariable("inpShowReg", "ReportGeneralLedgerJournal|ShowReg", "Y");
      String strShowOpening = vars.getGlobalVariable("inpShowOpening", "ReportGeneralLedgerJournal|ShowOpening", "Y");
      String strShowRegular = vars.getGlobalVariable("inpShowRegular", "ReportGeneralLedgerJournal|ShowRegular", "Y");
      String strShowDivideUp = vars.getGlobalVariable("inpShowDivideUp", "ReportGeneralLedgerJournal|ShowDivideUp", "Y");
      ...
      String initRecordNumberOld = vars.getSessionValue("ReportGeneralLedgerJournal.initRecordNumberOld", "0");
      ...
      String strEntryNo = vars.getGlobalVariable("inpEntryNo", "ReportGeneralLedgerJournal|EntryNo", "1");
      String strShowDescription = vars.getGlobalVariable("inpShowDescription", "ReportGeneralLedgerJournal|ShowDescription", "");
      printPageDataSheet(response, vars, strDateFrom, strDateTo, strDocument, strOrg, strTable, strRecord, "", strcAcctSchemaId, strShowClosing, strShowReg, strShowOpening, strPageNo, strEntryNo, strShowDescription, strShowRegular, strShowDivideUp, "", "");
    } else if (vars.commandIn("DIRECT")) {
      String strTable = vars.getGlobalVariable("inpTable", "ReportGeneralLedgerJournal|Table");
      String strRecord = vars.getGlobalVariable("inpRecord", "ReportGeneralLedgerJournal|Record");
      String strAccSchemas = vars.getGlobalVariable("inpAccSchemas", "ReportGeneralLedgerJournal|AccSchemas");
      ...
      vars.setSessionValue("ReportGeneralLedgerJournal.initRecordNumber", "0");
      printPageDataSheet(response, vars, "", "", "", "", strTable, strRecord, "", strcAcctSchemaId, "", "", "", "1", "1", "", "Y", "", schemas, strPosted);
      ...
      vars.setSessionValue("ReportGeneralLedgerJournal.initRecordNumber", "0");
      printPageDataSheet(response, vars, "", "", "", "", "", "", strFactAcctGroupId, "", "", "", "", "1", "1", "", "Y", "", "", "");
      ...
      String strOrg = vars.getGlobalVariable("inpOrg", "ReportGeneralLedgerJournal|Org", "0");
      String strShowClosing = vars.getRequestGlobalVariable("inpShowClosing", "ReportGeneralLedgerJournal|ShowClosing");
      if (strShowClosing == null || "".equals(strShowClosing))
        vars.setSessionValue("ReportGeneralLedgerJournal|ShowClosing", "N");
      String strShowDivideUp = vars.getRequestGlobalVariable("inpShowDivideUp", "ReportGeneralLedgerJournal|ShowDivideUp");
      if (strShowDivideUp == null || "".equals(strShowDivideUp))
        vars.setSessionValue("ReportGeneralLedgerJournal|ShowDivideUp", "N");
      String strShowRegular = vars.getRequestGlobalVariable("inpShowRegular", "ReportGeneralLedgerJournal|ShowRegular");
      if (strShowRegular == null || "".equals(strShowRegular))
        vars.setSessionValue("ReportGeneralLedgerJournal|ShowRegular", "N");
      String strShowReg = vars.getRequestGlobalVariable("inpShowReg", "ReportGeneralLedgerJournal|ShowReg");
      if (strShowReg == null || "".equals(strShowReg))
        vars.setSessionValue("ReportGeneralLedgerJournal|ShowReg", "N");
      String strShowOpening = vars.getRequestGlobalVariable("inpShowOpening", "ReportGeneralLedgerJournal|ShowOpening");
      if (strShowOpening == null || "".equals(strShowOpening))
        vars.setSessionValue("ReportGeneralLedgerJournal|ShowOpening", "N");
      if (!("Y".equals(strShowOpening)) && !("Y".equals(strShowReg)) && !("Y".equals(strShowRegular)) && !("Y".equals(strShowClosing)) && !("Y".equals(strShowDivideUp))) {
        strShowRegular = "Y";
      ...
      String strEntryNo = vars.getRequestGlobalVariable("inpEntryNo", "ReportGeneralLedgerJournal|EntryNo");
      String strShowDescription = vars.getRequestGlobalVariable("inpShowDescription", "ReportGeneralLedgerJournal|ShowDescription");
      if (strShowDescription == null || "".equals(strShowDescription))
        vars.setSessionValue("ReportGeneralLedgerJournal|ShowDescription", "N");
      printPageDataSheet(response, vars, strDateFrom, strDateTo, strDocument, strOrg, "", "", "", strcAcctSchemaId, strShowClosing, strShowReg, strShowOpening, strPageNo, strEntryNo, strShowDescription, strShowRegular, strShowDivideUp, "", "");
      ...
      strcAcctSchemaId = vars.getStringParameter("schemaId");
      String strTable = vars.getStringParameter("tableId");
      String strRecord = vars.getStringParameter("recordId");
...
//      String strRecord = vars.getStringParameter("inpRecord");
      ...
      if (strcAcctSchemaId.equals("") && strDateFrom.equals("") && strDocument.equals("") && strOrg.equals("0") && strShowClosing.equals("") && strShowReg.equals("") && strShowOpening.equals("") && strRecord.equals("")) {

        int currentHistoryIndex = new Integer(new VariablesHistory(request).getCurrentHistoryIndex()).intValue();
        String currentCommand = vars.getSessionValue("reqHistory.command" + currentHistoryIndex);
        if (currentCommand.equals("DIRECT2")) {
          strFactAcctGroupId = vars.getGlobalVariable("inpFactAcctGroupId", "ReportGeneralLedgerJournal|FactAcctGroupId");
        }
      }
      ...
      setHistoryCommand(request, "DEFAULT");
      printPagePDF(response, vars, strDateFrom, strDateTo, strDocument, strOrg, strTable, strRecord, strFactAcctGroupId, strcAcctSchemaId, strShowClosing, strShowReg, strShowOpening, strPageNo, strEntryNo, "Y".equals(strShowDescription) ? "Y" : "", strShowRegular, strShowDivideUp);
      ...
      int intRecordRange = strPreviousRecordRange.equals("") ? 0 : Integer.parseInt(strPreviousRecordRange);
      strPreviousRecordRange = previousRecord[1];
      intRecordRange += strPreviousRecordRange.equals("") ? 0 : Integer.parseInt(strPreviousRecordRange);
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strDocument, String strOrg, String strTable, String strRecord, String strFactAcctGroupId, String strcAcctSchemaId, String strShowClosing, String strShowReg, String strShowOpening, String strPageNo, String strEntryNo, String strShowDescription, String strShowRegular, String strShowDivideUp, String accShemas, String strPosted) throws IOException, ServletException {

    String strRecordRange = Utility.getContext(this, vars, "#RecordRange", "ReportGeneralLedgerJournal");
    int intRecordRangePredefined = (strRecordRange.equals("") ? 0 : Integer.parseInt(strRecordRange));
    String strInitRecord = vars.getSessionValue("ReportGeneralLedgerJournal.initRecordNumber");
    ...
    toolbar.prepareRelationBarTemplate(false, false, "imprimir2();return false;");

    int totalAcctEntries = 0;
    int lastRecordNumber = 0;
    if (vars.commandIn("FIND") || vars.commandIn("DEFAULT") && (!vars.getSessionValue("ReportGeneralLedgerJournal.initRecordNumber").equals("0") || "0".equals(vars.getSessionValue("ReportGeneralLedgerJournal.initRecordNumberOld", "")))) {
      String strCheck = buildCheck(strShowClosing, strShowReg, strShowOpening, strShowRegular, strShowDivideUp);
      String strTreeOrg = TreeData.getTreeOrg(this, vars.getClient());
      String strOrgFamily = getFamily(strTreeOrg, strOrg);
      if (strRecord.equals("")) {
        // Stores the number of lines per accounting entry
        dataCountLines = ReportGeneralLedgerJournalData.selectCountGroupedLines(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"), strDocument, strcAcctSchemaId, strOrgFamily, strCheck);

        String strInitAcctEntries = vars.getSessionValue(PREVIOUS_ACCTENTRIES);
        int acctEntries = (strInitAcctEntries.equals("") ? 0 : Integer.parseInt(strInitAcctEntries.split(",")[0]));
        ...
        int i = 1;
        while (groupedLines[i - 1] <= intRecordRangePredefined && dataCountLines.length >= acctEntries) {
          if (dataCountLines.length > acctEntries) {
            groupedLines[i] = groupedLines[i - 1] + Integer.parseInt(dataCountLines[acctEntries].groupedlines);
            i++;
          }
          acctEntries++;
        }
        ...
        vars.setSessionValue("ReportGeneralLedgerJournal.initRecordNumber", String.valueOf(lastRecordNumber));
        ...
        vars.setSessionValue(PREVIOUS_ACCTENTRIES, String.valueOf(acctEntries - 1) + "," + vars.getSessionValue(PREVIOUS_ACCTENTRIES));
        vars.setSessionValue(PREVIOUS_RANGE_OLD, vars.getSessionValue(PREVIOUS_RANGE));
        vars.setSessionValue(PREVIOUS_RANGE, String.valueOf(intRecordRangeUsed) + "," + vars.getSessionValue(PREVIOUS_RANGE));

        data = ReportGeneralLedgerJournalData.select(this, "'Y'", Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"), strDocument, strcAcctSchemaId, strOrgFamily, strCheck, vars.getLanguage(), initRecordNumber, intRecordRangeUsed);

        if (data != null && data.length > 0)
          strPosition = ReportGeneralLedgerJournalData.selectCount(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"), strDocument, strcAcctSchemaId, strOrgFamily, strCheck, data[0].dateacct, data[0].identifier);
      } else {
        data = ReportGeneralLedgerJournalData.selectDirect(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strTable, strRecord, strcAcctSchemaId, vars.getLanguage(), initRecordNumber, intRecordRangePredefined);

        if (data != null && data.length > 0)
          strPosition = ReportGeneralLedgerJournalData.selectCountDirect(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strTable, strRecord, strFactAcctGroupId, data[0].dateacct, data[0].identifier);
      }
    } else if (vars.commandIn("DIRECT")) {
      data = ReportGeneralLedgerJournalData.selectDirect(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strTable, strRecord, strcAcctSchemaId, vars.getLanguage());
      if (data != null && data.length > 0)
        strPosition = ReportGeneralLedgerJournalData.selectCountDirect(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strTable, strRecord, strFactAcctGroupId, data[0].dateacct, data[0].identifier);
    } else if (vars.commandIn("DIRECT2")) {
      data = ReportGeneralLedgerJournalData.selectDirect2(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strFactAcctGroupId, vars.getLanguage());
      if (data != null && data.length > 0)
        strPosition = ReportGeneralLedgerJournalData.selectCountDirect2(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strFactAcctGroupId, data[0].dateacct, data[0].identifier);
    }
    
    data= ReportGeneralLedgerJournalData.select_new(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"),  Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strTable, strRecord);
    ...
    for(int z=0;z<data.length;z++){
    	if(!data[z].isauto.equals("Y")){
    		totaldebe = totaldebe.add(new BigDecimal(data[z].amtacctdr));
        	totalhaber = totalhaber.add(new BigDecimal(data[z].amtacctcr));
    	}
    }
    
    ArrayList<ReportGeneralLedgerJournalData> tpp = new ArrayList<ReportGeneralLedgerJournalData>();
    
    ReportGeneralLedgerJournalData[] tt = new ReportGeneralLedgerJournalData[tpp.size()];
    
    ReportGeneralLedgerJournalData temp = new ReportGeneralLedgerJournalData();
    temp.rownum = "1";
    temp.amtacctdr = totaldebe.toString();
    temp.amtacctcr = totalhaber.toString();
    tpp.add(temp);
    
    xmlDocument.setData("structure2", tpp.toArray(tt));
    
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "LIST", "", "C_DocType DocBaseType", "", Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedgerJournal"), Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedgerJournal"), 0);
    ...
    xmlDocument.setParameter("recordId", strRecord);
    xmlDocument.setParameter("tableId", strTable);
    xmlDocument.setParameter("schemaId", strcAcctSchemaId);
    
    xmlDocument.setParameter("fieldTotaldebe", totaldebe.toString());
    xmlDocument.setParameter("fieldTotalhaber", totalhaber.toString());
    

    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "AD_ORG_ID", "", "", Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedgerJournal"), Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedgerJournal"), '*');
    ...
    xmlDocument.setData("reportC_ACCTSCHEMA_ID", "liststructure", AccountingSchemaMiscData.selectC_ACCTSCHEMA_ID(this, Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), strcAcctSchemaId));
    ...
    xmlDocument.setParameter("showDescription", ("".equals(strShowDescription)) ? "N" : strShowDescription);
  ...
  private ReportGeneralLedgerJournalData[] notshow(ReportGeneralLedgerJournalData[] data, VariablesSecureApp vars) {
    for (int i = 0; i < data.length - 1; i++) {
      if ((data[i].identifier.toString().equals(data[i + 1].identifier.toString())) && (data[i].dateacct.toString().equals(data[i + 1].dateacct.toString()))) {
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strDocument, String strOrg, String strTable, String strRecord, String strFactAcctGroupId, String strcAcctSchemaId, String strShowClosing, String strShowReg, String strShowOpening, String strPageNo, String strEntryNo, String strShowDescription, String strShowRegular, String strShowDivideUp) throws IOException, ServletException {
    ...
    if (!strFactAcctGroupId.equals("")) {
      ...
      String strCheck = buildCheck(strShowClosing, strShowReg, strShowOpening, strShowRegular, strShowDivideUp);
      data = ReportGeneralLedgerJournalData.select(this, "Y".equals(strShowDescription) ? "'Y'" : "'N'", Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"), strDocument, strcAcctSchemaId, strOrgFamily, strCheck, vars.getLanguage());
    } else
      data = ReportGeneralLedgerJournalData.selectDirect(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"), Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strTable, strRecord, strcAcctSchemaId, vars.getLanguage());

    List<ReportGeneralLedgerJournalData> dataArr = new ArrayList<ReportGeneralLedgerJournalData>();

    // REPORTGENERALLEDGERJOURNALDATA [] DATAX;

    ReportGeneralLedgerJournalData dataPagoProvedores = null;
    ReportGeneralLedgerJournalData dataDifCambio = null;

    for (int i = 0; i < data.length; i++) {
      if (data[i].value.indexOf("10") == 0) {
        dataPagoProvedores = data[i];
      } else if (data[i].value.indexOf("9551") == 0) {
        dataDifCambio = data[i];
      } else {
        dataArr.add(data[i]);
      }

    }
    if (dataDifCambio != null) {
      dataArr.add(dataDifCambio);
    }

    if (dataPagoProvedores != null) {
      dataArr.add(dataPagoProvedores);
    }

    for (int i = 0; i < dataArr.size(); i++) {
      data[i] = dataArr.get(i);
    }
    
    //agregando nueva consulta 
    data= ReportGeneralLedgerJournalData.select_data_report(this, Utility.getContext(this, vars, "#User_Client", "ReportGeneralLedger"),  Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportGeneralLedger"), strTable, strRecord);


    String strSubtitle = (Utility.messageBD(this, "LegalEntity", vars.getLanguage()) + ": ") + ReportGeneralLedgerJournalData.selectCompany(this, vars.getClient()) + "\n";
    ;

    if (!("0".equals(strOrg)))
      strSubtitle += (Utility.messageBD(this, "OBUIAPP_Organization", vars.getLanguage()) + ": ") + ReportGeneralLedgerJournalData.selectOrg(this, strOrg) + "\n";

    if (!"".equals(strDateFrom) || !"".equals(strDateTo))
      strSubtitle += (Utility.messageBD(this, "From", vars.getLanguage()) + ": ") + strDateFrom + "  " + (Utility.messageBD(this, "OBUIAPP_To", vars.getLanguage()) + ": ") + strDateTo + "\n";

    if (!"".equals(strcAcctSchemaId)) {
      AcctSchema financialMgmtAcctSchema = OBDal.getInstance().get(AcctSchema.class, strcAcctSchemaId);
      strSubtitle += Utility.messageBD(this, "generalLedger", vars.getLanguage()) + ": " + financialMgmtAcctSchema.getName();
    }
    
    
    ReportGeneralLedgerJournalData[] temp = null;
    
    for(int z=0;z<data.length;z++){
    	StringBuilder cadena = new StringBuilder("");
    	if(data[z].doctypeid.equalsIgnoreCase("9BCF5828C56F4C1D815A127A0961E71F")){
    		/* letra de venta */
    		
    		temp = ReportGeneralLedgerJournalData.getfromboeinvoice(this, data[z].emScoRecord3Id, data[z].id);
    		
    		for(int y=0;y<temp.length;y++){
    			
    			if(!data[z].emScoRecord3Id.equalsIgnoreCase(temp[y].ndocumento)){
    				if(!cadena.toString().equalsIgnoreCase("")){
            			cadena.append(", ");
            		}
            		cadena.append(temp[y].cencosrelacionado);
    			}
        	}
        	
        	data[z].cencosrelacionado = cadena.toString();
    		
    	}else if(data[z].tableid.equalsIgnoreCase("318")){
    		/* otros invoices */
    		temp = ReportGeneralLedgerJournalData.getfrominvoice(this, data[z].emScoRecord3Id, data[z].id);
    ...
    if (vars.commandIn("PDF")) {
      strOutput = "pdf";
      strReportName = "@basedesign@/org/openbravo/erpCommon/ad_reports/ReportGeneralLedgerJournalCOAM.jrxml";
    } else {
      strOutput = "pdf";
      strReportName = "@basedesign@/org/openbravo/erpCommon/ad_reports/ReportGeneralLedgerJournalCOAMv2.jrxml";
    }

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("ShowDescription", strShowDescription);
    parameters.put("Subtitle", strSubtitle);
    parameters.put("Razon", ReportGeneralLedgerJournalData.selectOrg(this, strOrg));
    parameters.put("Ruc", ReportGeneralLedgerJournalData.selectOrgTaxID(this, strOrg));
    ...
    renderJR(vars, response, strReportName, "JournalEntriesReport", strOutput, parameters, data, null);
  }
  ...
  private String buildCheck(String strShowClosing, String strShowReg, String strShowOpening, String strShowRegular, String strShowDivideUp) {
    String[] strElements = { strShowClosing.equals("Y") ? "'C'" : "", strShowReg.equals("Y") ? "'R'" : "", strShowOpening.equals("Y") ? "'O'" : "", strShowRegular.equals("Y") ? "'N'" : "", strShowDivideUp.equals("Y") ? "'D'" : "" };
    int no = 0;
    String strCheck = "";
  ...
  private <T extends BaseOBObject> String getJSONComboBox(Set<String> docbseTypes, String selectedValue, boolean isMandatory, VariablesSecureApp vars) {
  ...
  public static Set<String> getDocuments(String org, String accSchema) {
    ...
    try {
      ...
      Set<String> orgStrct = OBContext.getOBContext().getOrganizationStructureProvider().getNaturalTree(org);
      ...
      final OBQuery<DocumentType> obqDt = OBDal.getInstance().createQuery(DocumentType.class, whereClause.toString());
