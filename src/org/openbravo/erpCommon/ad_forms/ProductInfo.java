...
public class ProductInfo {
  ...
  public Account getAccount(String AcctType, AcctSchema as, ConnectionProvider conn) {
    if (Integer.parseInt(AcctType) < 1 || Integer.parseInt(AcctType) > 16)
      return null;
    ...
    try {
      ...
      case 12:
        ...
        break;
      case 13:
        validCombination_ID = data[0].stockvariance;
        break;
      case 14:
        validCombination_ID = data[0].otherrevenue;
        break;
      case 15:
        validCombination_ID = data[0].matexpense;
        break;
      case 16:
        validCombination_ID = data[0].matexpbridge;
        break;
      }
  ...
  public static final String ACCTTYPE_P_StockVariance = "13";
  /** Otros ingresos diversos por el producto */
  public static final String ACCTTYPE_P_OtherRevenue = "14";
  /** Gastos por consumo de material */
  public static final String ACCTTYPE_P_MatExpense = "15";
  /** Cuenta puente para gastos por consumo de material */
  public static final String ACCTTYPE_P_MatExpBridge = "16";
