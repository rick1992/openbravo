...
public class SL_JournalLineAmt extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      System.out.println("enter SL_JournalLineAmt");
      ...
      if (strCurrencyRate.isEmpty()) {
        strCurrencyRate = "1";
      }

      try {
        printPage(response, vars, strGLJournal, strCurrencyRate, strCurrency, strDateAcct, strCurrencyRateType, strWindowId, strAmtSourceDr, strAmtSourceCr, strTabId);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strGLJournal, String strCurrencyRate, String strCurrency, String strDateAcct, String strCurrencyRateType, String strWindowId, String strAmtSourceDr, String strAmtSourceCr, String strTabId) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
    ...
    String strPrecision = "12", strTargetCurrencyId = "";
    if (data != null && data.length > 0) {
      //strPrecision = data[0].stdprecision.equals("") ? "12" : data[0].stdprecision;
    ...
    System.out.println("StdPrecision:"+StdPrecision);
    ...
    AmtAcctDr = (strAmtSourceDr.equals("") ? ZERO : AmtSourceDr.multiply(CurrencyRateValue)).setScale(StdPrecision, BigDecimal.ROUND_HALF_UP);
    AmtAcctCr = (strAmtSourceCr.equals("") ? ZERO : AmtSourceCr.multiply(CurrencyRateValue)).setScale(StdPrecision, BigDecimal.ROUND_HALF_UP);
    ...
    resultado.append("new Array(\"inpcurrencyrate\", " + strCurrencyRate + "),");
