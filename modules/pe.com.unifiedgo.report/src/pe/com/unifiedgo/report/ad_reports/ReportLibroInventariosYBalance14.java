...
public class ReportLibroInventariosYBalance14 extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (vars.commandIn("DEFAULT")) {
			String strDateFrom = vars.getGlobalVariable("inpDateFrom", "ReportLibroInventariosYBalance14|DateFrom", "");
			String strDateTo = vars.getGlobalVariable("inpDateTo", "ReportLibroInventariosYBalance14|DateTo", "");
			String strOrg = vars.getGlobalVariable("inpOrg", "ReportLibroInventariosYBalance14|Org", "0");
			String strRecord = vars.getGlobalVariable("inpRecord", "ReportLibroInventariosYBalance14|Record", "");
			String strTable = vars.getGlobalVariable("inpTable", "ReportLibroInventariosYBalance14|Table", "");
			...
			vars.setSessionValue("ReportLibroInventariosYBalance14.initRecordNumber", "0");
			printPageDataSheet(response, vars, "", "", "", strTable, strRecord);

		} else if (vars.commandIn("FIND")) {
			String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom",
					"ReportLibroInventariosYBalance14|DateFrom");
			String strDateTo = vars.getRequestGlobalVariable("inpDateTo", "ReportLibroInventariosYBalance14|DateTo");
			String strOrg = vars.getGlobalVariable("inpOrg", "ReportLibroInventariosYBalance14|Org", "0");
			vars.setSessionValue("ReportLibroInventariosYBalance14.initRecordNumber", "0");
	...
	private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom,
		...
		ReportLibroInventariosYBalance14Data[] data = null;
		String strPosition = "0";

		String discard[] = { "discard" };

		xmlDocument = xmlEngine
				.readXmlTemplate("pe/com/unifiedgo/report/ad_reports/ReportLibroInventariosYBalance14", discard)
				.createXmlDocument();

		ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReportLibroInventariosYBalance14", false, "", "",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"pe.com.unifiedgo.report.ad_reports.ReportLibroInventariosYBalance14");
			xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
			xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
			xmlDocument.setParameter("childTabContainer", tabs.childTabs());
			xmlDocument.setParameter("theme", vars.getTheme());
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ReportLibroInventariosYBalance14.html",
					classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ReportLibroInventariosYBalance14.html",
					strReplaceWith);
		...
		{
			OBError myMessage = vars.getMessage("ReportLibroInventariosYBalance14");
			vars.removeMessage("ReportLibroInventariosYBalance14");
			if (myMessage != null) {
		...
		try {
			ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "AD_ORG_ID", "",
					...
					Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportLibroInventariosYBalance14"),
					Utility.getContext(this, vars, "#User_Client", "ReportLibroInventariosYBalance14"), '*');
			comboTableData.fillParameters(null, "ReportLibroInventariosYBalance14", "");
		...
		vars.setSessionValue("ReportLibroInventariosYBalance14|Record", strRecord);
		vars.setSessionValue("ReportLibroInventariosYBalance14|Table", strTable);
		...
		xmlDocument.setParameter("paramPeriodosArray",
				Utility.arrayInfinitasEntradas("idperiodo;periodo;fechainicial;fechafinal;idorganizacion",
						"arrPeriodos", ReportLibroInventariosYBalance14Data.select_periodos(this)));
	...
	private void printPagePDF(HttpServletRequest request, HttpServletResponse response, VariablesSecureApp vars,
		...
		data = ReportLibroInventariosYBalance14Data.getSaldoCuenta14V2(this, strDateTo, strOrg);
		...
		String strSubtitle = (Utility.messageBD(this, "LegalEntity", vars.getLanguage()) + ": ")
				+ ReportLibroInventariosYBalance14Data.selectCompany(this, vars.getClient()) + "\n" + "RUC:"
				+ ReportLibroInventariosYBalance14Data.selectRucOrg(this, strOrg) + "\n";

		if (!("0".equals(strOrg)))
			strSubtitle += (Utility.messageBD(this, "OBUIAPP_Organization", vars.getLanguage()) + ": ")
					+ ReportLibroInventariosYBalance14Data.selectOrg(this, strOrg) + "\n";

		String strOutput;
		String strReportName;
		if (vars.commandIn("PDF")) {
			strOutput = "pdf";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReportLibroInventariosYBalance14.jrxml";
		} else {
			strOutput = "xls";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReportLibroInventariosYBalance14Excel.jrxml";
		}

		HashMap<String, Object> parameters = new HashMap<String, Object>();
		parameters.put("Subtitle", strSubtitle);
		parameters.put("Ruc", ReportLibroInventariosYBalance14Data.selectRucOrg(this, strOrg));
		parameters.put("Razon", ReportLibroInventariosYBalance14Data.selectSocialName(this, strOrg));
		parameters.put("strDateFrom", fechaIniAnioActual);
		parameters.put("strDateTo", strDateTo);
		parameters.put("dateTo", StringToDate(strDateTo));
		
		renderJR(vars, response, strReportName, "LibroIB_Cuenta14", strOutput, parameters, data, null);
	}

	private static ReportLibroInventariosYBalance14Data[] getData(ConnectionProvider conn, VariablesSecureApp vars,
		...
		data = ReportLibroInventariosYBalance14Data.getSaldoCuenta14(conn, strDateTo, strOrg);
		if (data == null)
			return data;

		for (int i = 0; i < data.length; i++) {

			ReportLibroInventariosYBalance14Data doc = data[i];
			...
			/// CONFIGURANDO DATA PARA REPORTE
			doc.codetaxid = bpDocumentType;
			doc.taxid = bpDocNumber;
			doc.name = bpName;
//			doc.dateacct = dateacct;

			String linea = period + "|" + regnumber + "|" + assetNo + "|" +
			 bpDocumentType + "|"
			+ bpDocNumber + "|" + bpName + "|" + dateacct + "|" +
			 String.format("%.2f", amtToPay)
			 + "|" + OpStatus + "|";
	...
	public static StructPle getDataPLECuenta14(
		      ReportLibroInventariosYBalance14Data[] data, Date dateFrom, Date dateTo, String strOrg)
		      throws Exception {
	...
	public static StructPle getStructPLECuenta14(ConnectionProvider conn, VariablesSecureApp vars,  Date strDateFrom,
	    ...
	    ReportLibroInventariosYBalance14Data[] data = ReportLibroInventariosYBalance14Data.getSaldoCuenta14V2(conn, strDttTo, strOrg);
	    ...
	    String filename = "LE" + rucAdq + dt.format(strDateTo) + "030400011111.TXT"; // LERRRRRRRRRRRAAAAMMDD030400CCOIM1.TXT
	...
	public String getServletInfo() {
		return "Servlet ReportLibroInventariosYBalance14. This Servlet was made by Pablo Sarobe modified by everybody";
