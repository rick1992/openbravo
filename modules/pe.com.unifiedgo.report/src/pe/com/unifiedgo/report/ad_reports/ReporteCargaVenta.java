...
public class ReporteCargaVenta extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocDate = vars.getGlobalVariable("inpDocDate", "ReporteCargaVenta|docDate",
          SREDateTimeData.today(this));
      String strProyDate = vars.getGlobalVariable("inpProyDate", "ReporteCargaVenta|proyDate",
          SREDateTimeData.tomorrow(this));
      String strAD_Org_ID = vars.getGlobalVariable("inpadOrgId", "ReporteCargaVenta|AD_Org_ID", "");
  ...
  private void printPagePDF(HttpServletRequest request, HttpServletResponse response,
    ...
    ReporteCargaVentaData[] data = null;

    try {
      data = ReporteCargaVentaData.select(strAD_Org_ID, vars.getSessionValue("#AD_CLIENT_ID"),
          strDocDate, strProyDate, vars.getSessionValue("#AD_USER_ID"));
    } catch (OBException e) {
    ...
    if (vars.commandIn("PDF")) {
      strOutput = "pdf";
      strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteCargaVenta.jrxml";
    } else {
      strOutput = "xls";
      strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteCargaVentaExcel.jrxml";
    }
    HashMap<String, Object> parameters = new HashMap<String, Object>();

    parameters.put("organizacion", ReporteCargaVentaData.selectSocialName(this, strAD_Org_ID));
    ...
    String name = "001A1_VENTA_PE" + org.getOrganizationInformationList().get(0).getTaxID() + "_"
        + city + "_" + fecha + "_" + hora;
  ...
  //
  // xmlDocument = xmlEngine.readXmlTemplate("pe/com/unifiedgo/report/ad_reports/ReporteCargaVenta",
  ...
  // data = ReporteCargaVentaData.set();
  // } else {
  ...
  // if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
  //
  // ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReporteCargaVenta", false, "", "",
  ...
  // "pe.com.unifiedgo.report.ad_reports.ReporteCargaVenta");
  // xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
  // xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
  // xmlDocument.setParameter("childTabContainer", tabs.childTabs());
  // xmlDocument.setParameter("theme", vars.getTheme());
  // NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ReporteCargaVenta.html",
  // classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
  // xmlDocument.setParameter("navigationBar", nav.toString());
  // LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ReporteCargaVenta.html",
  // strReplaceWith);
  ...
  // }
  // {
  // OBError myMessage = vars.getMessage("ReporteCargaVenta");
  // vars.removeMessage("ReporteCargaVenta");
  // if (myMessage != null) {
  ...
  // "#AccessibleOrgTree", "ReporteCargaVenta"), Utility.getContext(this, vars,
  // "#User_Client", "ReporteCargaVenta"), 0);
  // Utility.fillSQLParameters(this, vars, null, comboTableData, "ReporteCargaVenta",
  // strAD_Org_ID);
