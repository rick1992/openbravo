...
function openSearch(strTop, strLeft, strSelectorName, strWindowName, validate, strForm, strItem, strSpanId, strValueID)
{
  if (strSelectorName!=null) {
    ...
    if (strSelectorName.indexOf("Location")!=-1) {
    	windowSearch(strSelectorName, 300, 600, strTop, strLeft, strWindowName, parameters, strValueID);
    } else  { 
    	windowSearch(strSelectorName, null, 900, strTop, strLeft, strWindowName, parameters, strValueID);
    }
  }
}
