...
public class SPR_Budget_Project extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    String strBudgetType = info.vars.getStringParameter("inptype");
    Project project = OBDal.getInstance().get(Project.class, strProjectId);

    if (project != null) {

      if (strBudgetType.toUpperCase().equals("BDG"))
        info.addResult("inpname", "Presupuesto - " + project.getName().trim());
