...
public class Locator extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strOrg = vars.getGlobalVariable("inpadOrgId", "Locator.adorgid", "");
      if ("".equals(strOrg) || strOrg == null) {
      	strOrg = strOrgId;	 // add by vafaster // Cuando refresca la busqueda, la organización se pierde, por eso
      	//fue definida en un atributo de la clase
        //strOrg = vars.getStringParameter("paramOrgTree"); //comment by vafaster
      }
