...
public class PrintFolio extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintFolio.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.FOLIO;
    // The prefix FOLIO is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTFOLIO";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsimFolioImportId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsimFolioImportId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_13",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_13");
  }
