...
public class PrintSalesProspect extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintSalesProspect.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    DocumentType documentType = DocumentType.SALESPROSPECT;
    // The prefix PRINTSALESPROSPECT is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTSALESPROSPECT";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpssaProjpropContractId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpssaProjpropContractId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_8",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_8");
  }
