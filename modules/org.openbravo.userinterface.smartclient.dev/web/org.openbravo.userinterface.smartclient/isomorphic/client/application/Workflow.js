...
// +link{group:loadingOptionalModules,Optional Modules} before you can use Process.
// <P>
// 
// @treeLocation Client Reference/Workflow
// @visibility workflow
...
isc.Process.addClassProperties({
    ...
    // <p>
    // Processes follow all the standard rules for encoding as +link{group:componentXML}, for
    // example:
    // <pre>
    // &lt;Process ID="<i>processId</i>"&gt;
    //     &lt;elements&gt;
    //        &lt;ServiceTask ID="<i>taskId</i>" ..&gt;
    //            &lt;inputFieldList&gt;
...
// +link{process.state}.
// <P>
// If the AdvancedCriteria evaluate to true, the +link{xorGateway.nextElement, nextElement} is chosen, otherwise the
// +link{xorGateway.failureElement, failureElement}.
// <P>
