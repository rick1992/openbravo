...
public class FormLocationDetailsJR extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletRequest request, HttpServletResponse response,
    ...
    FormLocationDetailsJRData[] data = null;
    String strConvRateErrorMsg = "";
    String discard[] = { "discard" };
    
    xmlDocument = xmlEngine.readXmlTemplate(
        "pe/com/unifiedgo/warehouse/ad_forms/FormLocationDetailsFilterJR", discard)
        .createXmlDocument();
    ...
    try {
    	...
    	data = FormLocationDetailsJRData.selectDetailProductLocator(vars,
    ...
    if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      if (data == null || data.length == 0) {
        ...
        data = FormLocationDetailsJRData.set();
      } else {
