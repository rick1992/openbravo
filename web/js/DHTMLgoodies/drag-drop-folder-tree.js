...
************************************************************************************************************/	
    ...
    var dragStarPos_Y;
        ...
        var showFolder = 1; //add by Vafaster // This one  show the Folder Icon if we want or not // 0 not Show Folder | 1 Show Folder (Default)
	...
	JSDragDropTree.prototype = {
		...
		,
		setShowFolder : function(newvalue)
		{ 
		  this.showFolder = newvalue;
		  this.plusClass = 'DragDropTree_plus_icon_to_coam_special';
		  this.minusClass = 'DragDropTree_minus_icon_to_coam_special'; 
		},
		//setShowTypeStyleCoam : function(newvalue)
		//{ if(newvalue==1){
			//this.plusClass = 'DragDropTree_plus_icon_to_coam_special';
			//this.minusClass = 'DragDropTree_minus_icon_to_coam_special';
		  //}
    ...
    ,
      ...
      JSTreeObj.dragNode_destination = false;
        ...
        currItem.insertBefore(img,aTag);
                ...
                if(JSTreeObj.showFolder==null || JSTreeObj.showFolder==1){
