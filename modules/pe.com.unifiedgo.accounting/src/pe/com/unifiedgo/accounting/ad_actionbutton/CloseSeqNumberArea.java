...
public class CloseSeqNumberArea extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      String strWindowId = vars.getGlobalVariable("inpwindowId", "CloseSeqNumberArea|Window_ID");
      String strTabId = vars.getGlobalVariable("inpTabId", "CloseSeqNumberArea|Tab_ID");
      String strPaymentId = "6D0B62F616B1439BA19BA5A0F3F28A01";/*vars.getGlobalVariable("inpfinPaymentId",
      ...
      try {
    	...
    	String strOperationType = vars.getStringParameter("inpOperationType");
      ...
      String strSelectedPaymentDetails = vars.getInStringParameter("inpScoAreaSchemaId",
          "", null);
      ...
      printGrid(response, vars, strPeriodoId, strBusinessPartnerId, strPaymentId, strOrgId, strExpectedDateFrom,
          strExpectedDateTo, strDocumentType, strSelectedPaymentDetails, isReceipt,
          showAlternativePM, strDocNo, showAllFinancialAccount, strTabId, 
          strCContable, strOperationType);
    	...
    	String strSelectedrecordsIds = vars.getInStringParameter("inpScoAreaSchemaId", "", null);
    	
    	String[] Registros=null;
    	
    	if(!strSelectedrecordsIds.equals("")){
    		try{
    			strSelectedrecordsIds = strSelectedrecordsIds.replace("(", "").replace(")", "").replace("'", "").replace(" ", "");
    			Registros = strSelectedrecordsIds.split(",");
    		}catch(Exception ex){
    			strSelectedrecordsIds = "";
    		}
    		
    	}
    	
    	//CloseSeqNumberAreaData[] Registros = CloseSeqNumberAreaData.selectData(this/*, vars.getSessionValue("#AD_ORG_ID"), vars.getSessionValue("#AD_CLIENT_ID")*/, strPeriodoId,strOperationType);
    	
    	for(int i = 0; i < Registros.length; i++){
    		String docId = Registros[i];
    		
    		SCOAreaschema schema = OBDal.getInstance().get(SCOAreaschema.class, docId);
    		schema.setClosed(strOperationType.equalsIgnoreCase("N") ? true : false);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strPaymentId,
    ...
    try {
      ...
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("pe/com/unifiedgo/accounting/ad_actionbutton/CloseSeqNumberArea", discard).createXmlDocument();
      ...
      xmlDocument.setParameter("title", Utility.messageBD(this, "SCO_CloseSequences", vars.getLanguage()));
      ...
      try {
        ...
        Utility.fillSQLParameters(this, vars, null, comboTableData, "CloseSeqNumberArea", "");
...
*/
      ...
      CloseSeqNumberAreaData[] periodos = CloseSeqNumberAreaData.select_periodos(this);
  ...
  private void printGrid(HttpServletResponse response, VariablesSecureApp vars, String strPeriodoId,
      ...
      boolean showAllFinancialAcounts, String strTabId, String strCContable, String strOperationType) throws IOException, ServletException {
    ...
    CloseSeqNumberAreaData[] dataGrid = CloseSeqNumberAreaData.selectData(this, strPeriodoId, strOperationType);

    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("pe/com/unifiedgo/accounting/ad_actionbutton/AddPaymentGrid", discard).createXmlDocument();
  ...
  private void businessPartnerBlocked(HttpServletResponse response, VariablesSecureApp vars,
    ...
    try {
      ...
      log4j.error("CloseSeqNumberArea - Callback", e);
    }
  }
