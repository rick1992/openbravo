...
public class ExecutePayments extends HttpSecureAppServlet {
  ...
  //UGO Payment in/out related
  private static final String DocumentProvisionPaymentOutWindow = "5D5528FE6B16409580CA844E66CAA065";
  private static final String AplicacionCobrosWindow = "E4A31A40742A48D59CB35F78D8AF085A";
  private static final String AplicacionPagosWindow = "C6F5BFA9920F4393A77262D3EF1F4E7D";
  private static final String PagoProveedoresRelacionadosWindow = "C6971F086CB64AEEA08FD587BCFDE26E";
  private static final String CobroDescuentoPersonalMuestreoWindow = "347FE79197484BAD84F6346D3FDF5DC7";
  private static final String CobroCajaEfectivoWindow = "4EE739A098A340EBB3513B18F9BE9401";
  private static final String CobroDescuentoPersonalDeudaClienteWindow = "EF2924E8C37A47BB866300F725D9A7B6";
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      Enumeration<String> ps = vars.getParameterNames();
      while(ps.hasMoreElements()){
    	  String key = ps.nextElement();
    	  System.out.println(key + " : " + vars.getStringParameter(key));
      }
  ...
  private void processAndClose(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (PaymentInWindow.equals(strWindowId) || PaymentOutWindow.equals(strWindowId)
    		|| DocumentProvisionPaymentOutWindow.equals(strWindowId)
    		|| AplicacionCobrosWindow.equals(strWindowId)
    		|| AplicacionPagosWindow.equals(strWindowId)
    		|| PagoProveedoresRelacionadosWindow.equals(strWindowId)
    		|| CobroDescuentoPersonalMuestreoWindow.equals(strWindowId)
    		|| CobroCajaEfectivoWindow.equals(strWindowId)
    		|| CobroDescuentoPersonalDeudaClienteWindow.equals(strWindowId)
