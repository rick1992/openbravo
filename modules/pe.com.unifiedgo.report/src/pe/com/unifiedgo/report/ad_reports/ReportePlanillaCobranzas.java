...
public class ReportePlanillaCobranzas extends
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (vars.commandIn("DEFAULT")) {
			String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"ReportePlanillaCobranzas|DateFrom", "");
			String strDateTo = vars.getGlobalVariable("inpDateTo",
					"ReportePlanillaCobranzas|DateTo", "");
			String strOrg = vars.getGlobalVariable("inpOrg",
					"ReportePlanillaCobranzas|Org", "0");
			String strRecord = vars.getGlobalVariable("inpRecord",
					"ReportePlanillaCobranzas|Record", "");
			String strTable = vars.getGlobalVariable("inpTable",
					"ReportePlanillaCobranzas|Table", "");
			...
			vars.setSessionValue(
					"ReportePlanillaCobranzas.initRecordNumber",
					"0");
	...
	private void printPageDataSheet(HttpServletResponse response,
		...
		ReportePlanillaCobranzasData[] data = null;
		String strPosition = "0";
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"ReportePlanillaCobranzas", false, "", "",
...
//					false,
//					false,
//					"submitCommandForm('XLS', false, null, 'ReportePlanillaCobranzas.xls', 'EXCEL');return false;");
			xmlDocument = xmlEngine
					.readXmlTemplate(
							"pe/com/unifiedgo/report/ad_reports/ReportePlanillaCobranzas",
							discard).createXmlDocument();
			data = ReportePlanillaCobranzasData.set("0");
			data[0].rownum = "0";
		}
		...
		}
		{
			OBError myMessage = vars
					.getMessage("ReportePlanillaCobranzas");
			vars.removeMessage("ReportePlanillaCobranzas");
			if (myMessage != null) {
		...
		xmlDocument.setParameter("paramPeriodosArray", Utility.arrayInfinitasEntradas("idperiodo;periodo;fechainicial;fechafinal;idorganizacion","arrPeriodos",
	  			ReportePlanillaCobranzasData
				.select_periodos(this)));
		vars.setSessionValue(
				"ReportePlanillaCobranzas|Record", strRecord);
		vars.setSessionValue(
				"ReportePlanillaCobranzas|Table", strTable);
	...
	private void printPagePDF(HttpServletRequest request,HttpServletResponse response,
		...
		ArrayList<ReportePlanillaCobranzasData> listData = new ArrayList<ReportePlanillaCobranzasData>();

		String strTreeOrg = TreeData.getTreeOrg(this, vars.getClient());
		String strOrgFamily = getFamily(strTreeOrg, strOrg);

		data = ReportePlanillaCobranzasData
		...
		String strSubtitle = (Utility.messageBD(this, "LegalEntity",
				vars.getLanguage()) + ": ")
				+ ReportePlanillaCobranzasData.selectCompany(
						this, vars.getClient())
				+ "\n"
				+ "RUC:"
				+ ReportePlanillaCobranzasData.selectRucOrg(
						this, strOrg) + "\n";

		if (!("0".equals(strOrg)))
			strSubtitle += (Utility.messageBD(this, "OBUIAPP_Organization",
					vars.getLanguage()) + ": ")
					+ ReportePlanillaCobranzasData.selectOrg(
							this, strOrg) + "\n";
		...
		if (vars.commandIn("PDF")) {
			strOutput = "pdf";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReportePlanillaCobranzas.jrxml";
		} else {
			strOutput = "xls";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReportePlanillaCobranzasExcel.jrxml";
		}

		HashMap<String, Object> parameters = new HashMap<String, Object>();
		// parameters.put("Subtitle", strSubtitle);
		parameters.put("Ruc", ReportePlanillaCobranzasData
	...
	public String getServletInfo() {
		return "Servlet ReportePlanillaCobranzas. This Servlet was made by Pablo Sarobe modified by everybody";
