...
public class StandardAlgorithm extends CostingAlgorithm {
  ...
  protected BigDecimal getOutgoingTransactionCost(MaterialTransaction trx) {
	    BigDecimal standardCost = CostingUtils.getStandardCost(trx.getProduct(), costOrg,
	    		trx.getTransactionProcessDate(), costDimensions, costCurrency);
	    return standardCost.multiply(trx.getMovementQuantity().abs());
	  }
}
