...
public class DalUtil {
  ...
  private static final String SORTINGIDENTIFIER_PART_PATH = "_sortingIdentifier";
  ...
  public static Property getPropertyFromPath(Entity entity, String propertyPath) {
    ...
    for (String part : parts) {
      ...
      } else if (part.equals(SORTINGIDENTIFIER_PART_PATH)) {
        // pick the first identifier property
        if (currentEntity.getSortingIdentifierProperties().isEmpty()) {
          return null;
        }
        return currentEntity.getSortingIdentifierProperties().get(0);
      }
  ...
  public static Object getValueFromPath(BaseOBObject bob, String propertyPath) {
    ...
    for (String part : parts) {
      ...
      if (part.equals(IDENTIFIER_PART_PATH)) {
        ...
        return currentBob.getSortingIdentifier();
      }
  ...
  public static Serializable getId(Object o) {
    ...
    throw new ArgumentException("Argument is not a BaseOBObject and not a HibernateProxy " + (o != null ? o.getClass().getName() : "it is NULL"));
  }
  ...
  public static Serializable getReferencedPropertyValue(Property referencingProperty, Object referedObject) {
    Check.isTrue(referencingProperty.getReferencedProperty() != null, "This property " + referencingProperty + " does not have a referenced Property");
