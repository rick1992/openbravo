...
public class ProductComplete extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue("ProductComplete.restrictadorgid",
          vars.getStringParameter("RestrictOrgId", ""));
      vars.setSessionValue("ProductComplete.producttotaldesc",
          vars.getStringParameter("ProductTotalDesc", ""));
      vars.setSessionValue("ProductComplete.restrictlineid",
          vars.getStringParameter("RestrictLineId", ""));
      vars.setSessionValue("ProductComplete.restrictcategoryid",
          vars.getStringParameter("RestrictCategoryId", ""));
      ...
      removePageSessionVariables(vars);
      String windowId = vars.getRequestGlobalVariable("WindowID", "ProductComplete.windowId");
      String strRestrictOrgId = vars.getGlobalVariable("RestrictOrgId",
          "ProductComplete.restrictadorgid", "");
      String strRestrictLineId = vars.getGlobalVariable("RestrictLineId",
          "ProductComplete.restrictlineid", "");
      String strRestrictCategoryId = vars.getGlobalVariable("RestrictCategoryId",
          "ProductComplete.restrictcategoryid", "");
      ...
      if (strStore.equals("Y")) {
        if (vars.getLanguage().equals("en_US"))
          data = ProductCompleteData.select(this, rownum, strKeyValue, "", strWarehouse,
              isCalledFromProduction, strRestrictLineId, strRestrictCategoryId, vars.getRole(),
              strBpartner, strClients, "1", pgLimit, oraLimit1, oraLimit2);
        else
          data = ProductCompleteData.selecttrl(this, vars.getLanguage(), rownum, strKeyValue, "",
              strWarehouse, isCalledFromProduction, strRestrictLineId, strRestrictCategoryId,
              vars.getRole(), strBpartner, strClients, "1", pgLimit, oraLimit1, oraLimit2);
      } else {
        if (vars.getLanguage().equals("en_US"))
          data = ProductCompleteData.selectNotStored(this, rownum, strKeyValue, "", strBpartner,
              strClients, strOrgs, isCalledFromProduction, strRestrictLineId,
              strRestrictCategoryId, "1", pgLimit, oraLimit1, oraLimit2);
        else
          data = ProductCompleteData.selectNotStoredtrl(this, rownum, vars.getLanguage(),
              strKeyValue, "", strBpartner, strClients, strOrgs, isCalledFromProduction,
              strRestrictLineId, strRestrictCategoryId, "1", pgLimit, oraLimit1, oraLimit2);
      }
      ...
      String strRestrictOrgId = vars.getGlobalVariable("RestrictOrgId",
          "ProductComplete.restrictadorgid", "");
      String strIsProductTotalDesc = vars.getGlobalVariable("ProductTotalDesc",
          "ProductComplete.producttotaldesc", "");
      String strRestrictLineId = vars.getGlobalVariable("RestrictLineId",
          "ProductComplete.restrictlineid", "");
      String strRestrictCategoryId = vars.getGlobalVariable("RestrictCategoryId",
          "ProductComplete.restrictcategoryid", "");
      ...
      printGridData(response, vars, strKey, strName, strWarehouse, strBpartner, strStore,
          ...
          strPageSize, strNewFilter, strIsProductTotalDesc, strRestrictLineId,
          strRestrictCategoryId);
    } else
      pageError(response);
  }
  ...
  private void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strKey,
      ...
      String strIsProductTotalDesc, String strRestrictLineId, String strRestrictCategoryId)
      throws IOException, ServletException {
    if (log4j.isDebugEnabled())
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) {
          ...
          if (strStore.equals("Y")) {
            ...
            strNumRows = ProductCompleteData.countRows(this, rownum, strKey, strName, strWarehouse,
                strIsCalledFromProduction, strRestrictLineId, strRestrictCategoryId,
                vars.getRole(), strBpartner, strClients, pgLimit, oraLimit1, oraLimit2);
          } else {
            ...
            strNumRows = ProductCompleteData.countRowsNotStored(this, rownum, strKey, strName,
                strBpartner, strClients, strOrgs, strIsCalledFromProduction, strRestrictLineId,
                strRestrictCategoryId, pgLimit, oraLimit1, oraLimit2);
          }
          ...
          if (strStore.equals("Y")) {
            if (vars.getLanguage().equals("en_US"))
              data = ProductCompleteData.select(this, "ROWNUM", strKey, strName, strWarehouse,
                  strIsCalledFromProduction, strRestrictLineId, strRestrictCategoryId,
                  vars.getRole(), strBpartner, strClients, strOrderBy, "", oraLimit1, oraLimit2);
            else
              data = ProductCompleteData.selecttrl(this, vars.getLanguage(), "ROWNUM", strKey,
                  strName, strWarehouse, strIsCalledFromProduction, strRestrictLineId,
                  strRestrictCategoryId, vars.getRole(), strBpartner, strClients, strOrderBy, "",
                  oraLimit1, oraLimit2);
          } else {
            if (vars.getLanguage().equals("en_US"))
              data = ProductCompleteData.selectNotStored(this, "ROWNUM", strKey, strName,
                  strBpartner, strClients, strOrgs, strIsCalledFromProduction, strRestrictLineId,
                  strRestrictCategoryId, strOrderBy, "", oraLimit1, oraLimit2);
            else
              data = ProductCompleteData.selectNotStoredtrl(this, "ROWNUM", vars.getLanguage(),
                  strKey, strName, strBpartner, strClients, strOrgs, strIsCalledFromProduction,
                  strRestrictLineId, strRestrictCategoryId, strOrderBy, "", oraLimit1, oraLimit2);
          }
        } else {
          ...
          if (strStore.equals("Y")) {
            if (vars.getLanguage().equals("en_US"))
              data = ProductCompleteData.select(this, "1", strKey, strName, strWarehouse,
                  strIsCalledFromProduction, strRestrictLineId, strRestrictCategoryId,
                  vars.getRole(), strBpartner, strClients, strOrderBy, pgLimit, "", "");
            else
              data = ProductCompleteData.selecttrl(this, vars.getLanguage(), "1", strKey, strName,
                  strWarehouse, strIsCalledFromProduction, strRestrictLineId,
                  strRestrictCategoryId, vars.getRole(), strBpartner, strClients, strOrderBy,
                  pgLimit, "", "");
          } else {
            if (vars.getLanguage().equals("en_US"))
              data = ProductCompleteData.selectNotStored(this, "1", strKey, strName, strBpartner,
                  strClients, strOrgs, strIsCalledFromProduction, strRestrictLineId,
                  strRestrictCategoryId, strOrderBy, pgLimit, "", "");
            else
              data = ProductCompleteData.selectNotStoredtrl(this, "1", vars.getLanguage(), strKey,
                  strName, strBpartner, strClients, strOrgs, strIsCalledFromProduction,
                  strRestrictLineId, strRestrictCategoryId, strOrderBy, pgLimit, "", "");
          }
      ...
      for (int j = 0; j < data.length; j++) {
        ...
        for (int k = 0; k < headers.length; k++) {
          ...
          if (columnname.equalsIgnoreCase("rowkey")) {
            ...
            if (strIsProductTotalDesc != null && strIsProductTotalDesc.equals("Y")) {
            ...
            rowKey.append(data[j].getField("value") + " - " + data[j].getField("name"));
