...
public class BOEMarkAsReceivedActionHandler extends BaseActionHandler {
  private static final Logger log4j = Logger.getLogger(BOEMarkAsReceivedActionHandler.class);
      ...
      for (int i = 0; i < ssa_boe_id_array.length(); i++) {
        ...
        if (boe != null) {
          if (("SCOARBOEINVOICE".equals(boe.getSCOSpecialDocType())
            ...
            boe.setScrIsreceived(true);
            boe.setSsaBoeDatereceipt(new Date());
