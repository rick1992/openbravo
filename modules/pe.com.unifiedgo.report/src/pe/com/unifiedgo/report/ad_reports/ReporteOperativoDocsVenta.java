...
public class ReporteOperativoDocsVenta extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strAD_Org_ID = vars.getGlobalVariable("inpOrgId", "ReporteOperativoDocsVenta|OrgId","");
  ...
  private void printPageXLS(HttpServletRequest request, HttpServletResponse response,
    ...
    ReporteOperativoDocsVentaData[] data = null;
    ...
    try {
      data = ReporteOperativoDocsVentaData.selectData(this, strAD_Org_ID, strDateFrom, strDateTo, strDocTypeId, strCCostCenterID, strBPartnerId, strFilter);
    } catch (OBException e) {
    ...
    if(vars.commandIn("PDF")){
    	strOutput = "pdf";
        strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteOperativoDocsVenta.jrxml";
    }else{
    	strOutput = "xls";
        strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteOperativoDocsVentaExcel.jrxml";
    }

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    String orgname = ReporteOperativoDocsVentaData.selectOrg(this, strAD_Org_ID).toString();

    /* parameters */
    parameters.put("ORGANIZACION", ReporteOperativoDocsVentaData.selectOrg(this, strAD_Org_ID));
    parameters.put("RUC", ReporteOperativoDocsVentaData.selectRuc(this, strAD_Org_ID));
  ...
  private void printPageDataSheet(HttpServletRequest request, HttpServletResponse response,
    ...
    ReporteOperativoDocsVentaData[] dataItems = null;
    ...
    xmlDocument = xmlEngine.readXmlTemplate(
        "pe/com/unifiedgo/report/ad_reports/ReporteOperativoDocsVenta", discard)
        .createXmlDocument();
    ...
    if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      ...
      ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReporteOperativoDocsVenta", false,
      ...
      try {
        WindowTabs tabs = new WindowTabs(this, vars,
            "pe.com.unifiedgo.report.ad_reports.ReporteOperativoDocsVenta");
        xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
        xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
        xmlDocument.setParameter("childTabContainer", tabs.childTabs());
        xmlDocument.setParameter("theme", vars.getTheme());
        NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
            "ReporteOperativoDocsVenta.html", classInfo.id, classInfo.type, strReplaceWith,
            tabs.breadcrumb());
        xmlDocument.setParameter("navigationBar", nav.toString());
        LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
            "ReporteOperativoDocsVenta.html", strReplaceWith);
      ...
      {
        OBError myMessage = vars.getMessage("ReporteOperativoDocsVenta");
        vars.removeMessage("ReporteOperativoDocsVenta");
        if (myMessage != null) {
