...
public class CallAcctServer extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strTableId, String strOrgId, String strMessage, String strDateFrom, String strDateTo) throws IOException, ServletException {
    ...
    }
    {
      ...
      if (log4j.isDebugEnabled())
        log4j.debug("select tables org:" + Utility.getContext(this, vars, "#User_Org", "") + ", Client:" + Utility.getContext(this, vars, "#User_Client", "") + ",lang:" + vars.getLanguage());
      if (log4j.isDebugEnabled())
      ...
      data = AcctServerData.selectOrganizations(this, Utility.getContext(this, vars, "#User_Client", ""));
      if (log4j.isDebugEnabled())
        log4j.debug("select organizations:" + Utility.getContext(this, vars, "#User_Org", "") + ", Client:" + Utility.getContext(this, vars, "#User_Client", ""));
      if (log4j.isDebugEnabled())
        log4j.debug("lenght:" + data.length);
  ...
  private void runProcess(HttpServletResponse response, VariablesSecureApp vars, String strTableId, String strOrgId, String adProcessId, String strDateFrom, String strDateTo) throws IOException, ServletException {
    OBError myMessage = new OBError();
    myMessage.setTitle("");
    boolean scheduled = false;
    try {
      //UGO MODIFIED: Do not check for background process
      /*CallAcctServerData[] data = CallAcctServerData.selectByProcessId(this, adProcessId, vars.getClient());
      if (data.length > 0) {
      ...
      if (!scheduled) {
        ...
        PInstanceProcessData.insertPInstance(this, adPinstanceId, adProcessId, strOrgId, "N", vars.getUser(), vars.getClient(), vars.getOrg());
        ...
        PInstanceProcessData.insertPInstanceParam(this, adPinstanceId, "20", "AD_Org_ID", strOrgId, vars.getClient(), vars.getOrg(), vars.getUser());
        PInstanceProcessData.insertPInstanceParam(this, adPinstanceId, "30", "DateFrom", strDateFrom, vars.getClient(), vars.getOrg(), vars.getUser());
        PInstanceProcessData.insertPInstanceParam(this, adPinstanceId, "40", "DateTo", strDateTo, vars.getClient(), vars.getOrg(), vars.getUser());
