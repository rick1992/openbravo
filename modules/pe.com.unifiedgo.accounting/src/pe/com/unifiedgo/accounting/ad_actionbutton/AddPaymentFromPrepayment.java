...
public class AddPaymentFromPrepayment extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strDocumentId = vars.getGlobalVariable("inpscoPrepaymentId", "");
      ...
      SCOPrepayment scoPrepayment = OBDal.getInstance().get(SCOPrepayment.class, strDocumentId);

      String strAmount = scoPrepayment.getAmount().toString();

      String strGlitemId = scoPrepayment.getPaymentglitem().getId();
      ...
      String strDocumentId = vars.getRequestGlobalVariable("inpscoPrepaymentId", "");
      ...
      /*
       * String paymentCurrencyId = vars.getRequiredStringParameter("inpCurrencyId"); BigDecimal
       * exchangeRate = new BigDecimal(vars.getRequiredNumericParameter("inpExchangeRate", "1"));
       * BigDecimal convertedAmount = new
       * BigDecimal(vars.getRequiredNumericParameter("inpActualConverted", strPaymentAmount));
       */
      ...
      try {
        ...
        BigDecimal retBigDecimal = new BigDecimal(strRetencion).setScale(2, RoundingMode.HALF_UP);
        ...
        if (strPaymentDocumentNo.startsWith("<")) {
          // get DocumentNo
          strPaymentDocumentNo = Utility.getDocumentNo(this, vars, "AddPaymentFromPrepayment",
        ...
        // FIN_Utility.getDate(strPaymentDate), strReferenceNo, dao.getObject(Currency.class,
        ...
        if (addedGLITemsArray != null) {
          for (int i = 0; i < addedGLITemsArray.length(); i++) {
            ...
            String prepaymentId = glItem.getString("glitemPrepaymentId");
            ...
            FIN_AddPayment.saveGLItem(payment, glItemAmtReal,
                ...
                scoPrepayment.getProject(), null, null, null, null, null, null,
                scoPrepayment.getDescription(), glItemAmt, exchangeRate,
                OBDal.getInstance().get(Currency.class, docCurrencyId), null, null, prepaymentId,
                null, null, null);
             ...
             * scoPrepayment.getDescription(),null);
             */
          }
        }
        ...
        scoPrepayment.setPayment(payment);
        // scoPrepayment.setUsedamount(new BigDecimal(0));
        OBDal.getInstance().save(scoPrepayment);
          ...
          try {
            ...
            if (payment.getFINPaymentDetailList().size() > 0) {
              ...
              for (int i = 0; i < pds.size(); i++) {
                ...
                pd.setScoDescription(scoPrepayment.getDescription());
                scoPrepayment.setPaymentDetails(pd);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
      ...
      SCOPrepayment scoPrepayment) throws IOException, ServletException {
    ...
    XmlDocument xmlDocument = xmlEngine
        .readXmlTemplate("pe/com/unifiedgo/accounting/ad_actionbutton/AddPaymentFromPrepayment")
        .createXmlDocument();
    ...
    xmlDocument.setParameter("title",
        Utility.messageBD(this, "Pago de Anticipo", vars.getLanguage()));
    ...
    xmlDocument.setParameter("paymentPrepay", strAmount);
    ...
    xmlDocument.setParameter("glitemPrepaymentId", scoPrepayment.getId());
    if (isReceipt) {
    ...
    String strDocTypeId = (String) CallStoredProcedure.getInstance().call("AD_GET_DOCTYPE",
        parameters, null);
    String strDocNo = Utility.getDocumentNo(this, vars, "AddPaymentFromPrepayment", "FIN_Payment",
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_Currency_ID",
          "", "", Utility.getContext(this, vars, "#AccessibleOrgTree", "AddPaymentFromPrepayment"),
          Utility.getContext(this, vars, "#User_Client", "AddPaymentFromPrepayment"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "AddPaymentFromPrepayment",
          strCurrencyId);
