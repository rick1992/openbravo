...
public class GLItemFormSelectorFilterExpresion implements FilterExpression {
  ...
  public String getExpression(Map<String, String> requestMap) {
    ...
    String gldefaultcat = requestMap.get("gldefaultcat") != null ? requestMap.get("gldefaultcat")
        : "";
    ...
    if (gldefaultcat.compareTo("") != 0) {
      if (whereClause.length() != 0)
        whereClause.append(" and ");
      whereClause.append("e.scoScoGlitemCategory.searchKey = '" + gldefaultcat + "'");
    } else {
      if (whereClause.length() != 0)
        whereClause.append(" and ");
      whereClause.append("e.scoScoGlitemCategory.searchKey = 'global'");
    }
