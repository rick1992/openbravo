...
public class DefaultJsonDataService implements JsonDataService {
   ...
   */
  public String fetch(Map<String, String> parameters, boolean isExportCSV) {
    try {
      ...
      if (id != null) {
        ...
        Map<String, String> paramsCount = (Map<String, String>) ((HashMap<String, String>) parameters)
            .clone();
        DataEntityQueryService queryService = createSetQueryService(paramsCount, true, isExportCSV);
        ...
        queryService = createSetQueryService(parameters, false, isExportCSV);
        ...
        if (parameters.containsKey(JsonConstants.SUMMARY_PARAMETER)) {
          ...
          System.out.println(queryService.buildOBQuery());
        ...
        if (bobs.isEmpty()) {
          if (startRow > 0) {
            ...
            return fetch(parameters, isExportCSV);
          }
  ...
  public void fetch(Map<String, String> parameters, QueryResultWriter writer, boolean isExportCSV) {
    long t = System.currentTimeMillis();
    final String entityName = parameters.get(JsonConstants.ENTITYNAME);
    final DataEntityQueryService queryService = createSetQueryService(parameters, false, isExportCSV);
    queryService.setEntityName(entityName);
  ...
  protected DataEntityQueryService createSetQueryService(Map<String, String> parameters,
      boolean forCountOperation, boolean isExportCSV) {
    return createSetQueryService(parameters, forCountOperation, false, isExportCSV);
  }

  private DataEntityQueryService createSetQueryService(Map<String, String> parameters,
      boolean forCountOperation, boolean forSubEntity, boolean isExportCSV) {
    ...
    if (!forSubEntity && parameters.get(JsonConstants.DISTINCT_PARAMETER) != null) {
      ...
      queryService.setSubEntity(entityName,
          createSetQueryService(paramSubCriteria, forCountOperation, true, isExportCSV), distinctProperty,
