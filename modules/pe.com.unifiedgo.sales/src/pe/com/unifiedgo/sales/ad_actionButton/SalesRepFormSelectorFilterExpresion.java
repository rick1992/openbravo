...
public class SalesRepFormSelectorFilterExpresion implements FilterExpression {
  ...
  public String getExpression(Map<String, String> requestMap) {
    ...
    whereClause.append(" e.ssaChkIssalesrep is not null");
    whereClause.append(" and e.ssaChkIssalesrep='Y'");
