...
public class PrintPaymentValorizationSchedule extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintPaymentValorizationSchedule.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    DocumentType documentType = DocumentType.SRECONTRACTPAYSCHEDULE;
    // The prefix PRINTSALESPROSPECT is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTPAYMENTVALORIZATIONSCHEDULE";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsreContractPayscheduleId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsreContractPayscheduleId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_19",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_19");
  }
