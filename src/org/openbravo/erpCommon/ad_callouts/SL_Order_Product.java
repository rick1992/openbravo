...
public class SL_Order_Product extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      System.out.println("ENTER SL_Order_Product strChanged:" + strChanged);
      ...
      String product_data[] = SCO_Utils.getProductPricesByDate(this, order.getOrganization()
          .getId(), strMProductID, strPriceListId, order.getOrderDate());
      ...
      try {
        printPage(response, vars, strUOM, strPriceList, strPriceStd, strPriceLimit, strCurrency,
            ...
            strIsSOTrx, strQty, cancelPriceAd, strClientpolineId);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String _strUOM,
      ...
      String cancelPriceAd, String strClientpolineId) throws IOException, ServletException {
    ...
    if (!strMProductID.equals("")) {
      ...
      if (product != null && product.getPrdcProductgroup() != null) {
        strPrdcProductgroupId = product.getPrdcProductgroup().getId();
      }
    ...
    resultado
        .append("new Array(\"inpemSsaPrdcProductgroupId\",\"" + strPrdcProductgroupId + "\"),");
    resultado.append("new Array(\"inpprdcProductgroupId\",\"" + strPrdcProductgroupId + "\"),");
    ...
    if (!strCTaxID.equals("") && (strClientpolineId == null || strClientpolineId.equals(""))) {
    ...
    if (taxrate != null) {
      System.out.println("Enter SL_Order_Product  taxxxxx");
      ...
      System.out.println("rate:" + rate + " - priceactual:" + priceactual
          + " - inpemSsaTaxpriceactual111:" + taxpriceactual);

      System.out.println("rate:" + rate + " - priceactual:" + strPriceActual
          + " - inpemSsaTaxpriceactual111:" + taxpriceactual);
    ...
    resultado.append("new Array(\"inpemScrQtyAvailable\", \""
        + df.format(SCO_Utils.getTotalStockAvailable(strADOrgID, vars.getClient(), strMProductID))
        + "\"),");
    resultado.append("new Array(\"inpemScrQtyAvailWarehouse\", \""
        + df.format(SCO_Utils.getWarehouseStockAvailable(strADOrgID, vars.getClient(),
            strMWarehouseID, strMProductID)) + "\"),");
