...
public class ReporteMovimientos extends HttpSecureAppServlet {
	...
	private void printPageDataSheet(HttpServletRequest request,
		...
		xmlDocument = xmlEngine.readXmlTemplate(
				"pe/com/unifiedgo/report/ad_reports/ReporteMovimientos",
		...
		if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
			...
			try {
				...
				NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
						"ReporteMovimientos.html", classInfo.id,
						classInfo.type, strReplaceWith, tabs.breadcrumb());
				xmlDocument.setParameter("navigationBar", nav.toString());
				LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
						"ReporteMovimientos.html", strReplaceWith);
				xmlDocument.setParameter("leftTabs", lBar.manualTemplate());
			} catch (Exception ex) {
				throw new ServletException(ex);
			}
			{
				OBError myMessage = vars.getMessage("ReporteMovimientos");
				vars.removeMessage("ReporteMovimientos");
				if (myMessage != null) {
					xmlDocument
			...
			try {
				ComboTableData comboTableData = new ComboTableData(vars, this,
						...
						"0C754881EAD94243A161111916E9B9C6", Utility.getContext(
								...
								"ReporteMovimientos"), Utility.getContext(this,
								vars, "#User_Client", "ReporteMovimientos"), 0);
				// comboTableData.fillParameters(null,
				// "ReporteMovimientos", "");
				Utility.fillSQLParameters(this, vars, null, comboTableData,
						"ReporteMovimientos", strOrg);
			...
			try {
				...
				ReporteMovimientosData[] datax = ReporteMovimientosData
			...
			xmlDocument
					.setParameter("mWarehouseDescription",
							ReporteMovimientosData.selectMWarehouse(this,
									strWarehouse));
	...
	private void printPagePDF(HttpServletRequest request,
		...
		ReporteMovimientosData[] data = null;
		...
		if (strGrupoxTercero.equals("Y")) {
			...
			if (strTipoGrupo.compareTo("P") == 0) {
				data = ReporteMovimientosData.select_por_producto_conProveedor(
						this, strDateFrom, strDateTo, Utility.getContext(this,
								vars, "#User_Client", "ReporteMovimientos"),
				...
				data = ReporteMovimientosData
						.select_por_documento_conProveedor(this, strDateFrom,
								strDateTo, Utility.getContext(this, vars,
										"#User_Client", "ReporteMovimientos"),
								strOrgFamily, strIdAlmacen, strTipoMovimiento);
			}
			...
			if (strTipoGrupo.compareTo("P") == 0) {
				data = ReporteMovimientosData.select_por_producto(this,
						strDateFrom, strDateTo, strDateFrom, strDateTo, Utility
								.getContext(this, vars, "#User_Client",
										"ReporteMovimientos"), strOrgFamily,
						strIdAlmacen, strTipoMovimiento);

			}
			if (strTipoGrupo.compareTo("D") == 0) {
				data = ReporteMovimientosData.select_por_documento(this,
						strDateFrom, strDateTo, strDateFrom, strDateTo, Utility
								.getContext(this, vars, "#User_Client",
										"ReporteMovimientos"), strOrgFamily,
						strIdAlmacen, strTipoMovimiento);
...
//			data=null;
//			data = ReporteMovimientosData.select_movimientos_valorizado(this,
//					strDateFrom, strDateTo, strDateFrom, strDateTo, Utility
//							.getContext(this, vars, "#User_Client",
//									"ReporteMovimientos"), strOrgFamily,
//					strIdAlmacen, strTipoMovimiento);
//		}
		...
		String nombreArchivo = "Reporte de Movimientos";

		String strOutput;
		String strReportName;
		if (vars.commandIn("PDF")) {
			strOutput = "pdf";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteMovimientos.jrxml";
		} else {
			strOutput = "xls";

				strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteMovimientosExcel.jrxml";
		}
