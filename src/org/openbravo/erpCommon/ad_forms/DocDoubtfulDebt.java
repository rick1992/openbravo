  ...
  public Fact createFact(AcctSchema as, ConnectionProvider conn, Connection con,
    ...
    try {
      ...
      BigDecimal bpAmountConverted = convertAmount(new BigDecimal(Amounts[AMTTYPE_Gross]), !dd
          ...
          as, fact, Fact_Acct_Group_ID, nextSeqNo(SeqNo), conn, false, vTcOut);
      bpAmountConverted = new BigDecimal(Amounts[AMTTYPE_Gross]);
      ...
      for (int i = 0; i < data.length; i++) {
        ...
        line.m_Record_Id3 = dd.getFINPaymentSchedule()
                .getInvoice().getId();
