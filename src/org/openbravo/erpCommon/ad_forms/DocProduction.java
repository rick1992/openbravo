  ...
  public Fact createFact(AcctSchema as, ConnectionProvider conn, Connection con,
    ...
    for (int i = 0; p_lines != null && i < p_lines.length; i++) {
      ...
      if (CostingStatus.getInstance().isMigrated() && line.transaction != null
          ...
          (line.transaction.getProduct().getProductType().equals("I") && (line.transaction.getProduct().isStocked()
        		  || line.transaction.getProduct().isBillOfMaterials())  
        		  )
      ...
      if(line.transaction.getProduct().getProductType().equals("I") && (line.transaction.getProduct().isStocked()
    		  || line.transaction.getProduct().isBillOfMaterials()))
