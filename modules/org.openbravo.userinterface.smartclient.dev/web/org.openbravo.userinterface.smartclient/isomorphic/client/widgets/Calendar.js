...
// edit a set of events. Note that the +link{group:optionalModules, Calendar module} must be 
...
// @visibility external
//<
getZoneHoverHTML : function (zone, zoneCanvas, view) {
    return null;
},
...
// @visibility external
//<
getIndicatorHoverHTML : function (indicator, indicatorCanvas, view) {
    return this.getEventHoverHTML(indicator, indicatorCanvas, view);
},
...
// By default, the +link{calendar.eventCanvasCloseButton, close button}
// +link{calendar.eventCanvasCloseButton, close button}
// widgets for event canvases are shown only when the mouse is over a given event. The CSS style to apply to the +link{calendar.eventCanvasContextMenu, menu} displayed when 
// the rollover +link{calendar.eventCanvasContextButton, context button} is clicked.
// @visibility internal
//<
...
// rendering
    ...
    getHeaderHeight : function () {
        ...
        var height = !this.getShowBody() ? "100%" : (this.getHeaderWrap() ? "auto" : 
                this.headerHeight != null ? this.headerHeight : this.calendar.eventHeaderHeight+"px"); 
        return height;
    },
    ...
    getHeaderCSSText : function () {
        ...
        sb.append("overflow:hidden;vertical-align:middle;width:auto;height:", height,
            (this.getHeaderWrap() ? "" : ";text-wrap:none"),
            (this.getShowBody() ? "" : ";text-align:center"),
