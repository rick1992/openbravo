...
public class AddPaymentFromRendicionCuentasRefund extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      strAmount = vars.getRequestGlobalVariable("inprefund", "");
      ...
      try {
        ...
        if (strPaymentDocumentNo.startsWith("<")) {
          ...
          strPaymentDocumentNo = Utility.getDocumentNo(this, vars,
              "AddPaymentFromRendicionCuentasRefund", "FIN_Payment", strDocTypeId, strDocTypeId,
              false, true);
        }
        ...
        SCORendcurefundLine rendcu_refline = OBProvider.getInstance()
            .get(SCORendcurefundLine.class);
        rendcu_refline.setClient(scoRendicionCuentas.getClient());
        rendcu_refline.setOrganization(scoRendicionCuentas.getOrganization());
        rendcu_refline.setFINPaymentRefund(payment);
        rendcu_refline.setAmount(strConvertedAmount);
        rendcu_refline.setLineNo(SCO_Utils.getNextLineNo("sco_rendcurefund_line",
            "sco_rendicioncuentas_id", scoRendicionCuentas.getId()));
        rendcu_refline.setSCORendicioncuentas(scoRendicionCuentas);
        OBDal.getInstance().save(rendcu_refline);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine
        .readXmlTemplate(
            "pe/com/unifiedgo/accounting/ad_actionbutton/AddPaymentFromRendicionCuentasRefund")
        .createXmlDocument();
    ...
    xmlDocument.setParameter("title",
        Utility.messageBD(this, "Devolucion de Rendicion de cuentas", vars.getLanguage()));
    ...
    String strDocTypeId = (String) CallStoredProcedure.getInstance().call("AD_GET_DOCTYPE",
        parameters, null);
    String strDocNo = Utility.getDocumentNo(this, vars, "AddPaymentFromRendicionCuentasRefund",
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_Currency_ID",
          ...
          Utility.getContext(this, vars, "#AccessibleOrgTree",
              "AddPaymentFromRendicionCuentasRefund"),
          Utility.getContext(this, vars, "#User_Client", "AddPaymentFromRendicionCuentasRefund"),
          0);
      Utility.fillSQLParameters(this, vars, null, comboTableData,
          "AddPaymentFromRendicionCuentasRefund", strCurrencyId);
