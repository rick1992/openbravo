...
public class PrintSalesWithholdingReceipt extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintSalesWithholdingReceipt.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.SALESWITHHOLDINGRECEIPT;
    // The prefix PRINTSALESWITHHOLDINGRECEIPT is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTSALESWITHHOLDINGRECEIPT";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoSWithHoldingReceiptId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoSWithHoldingReceiptId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_5",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_5");
  }
