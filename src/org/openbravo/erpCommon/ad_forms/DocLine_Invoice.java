...
public class DocLine_Invoice extends DocLine {
  ...
  private String m_CustomGlDeferId = null;
  
  private boolean m_isDeferredOnReceipt = false;

  private String isNoEmitido = "N";
  
  public String getCustomGlDeferId(){
	  return m_CustomGlDeferId;
  }
  
  public void setCustomGlDeferId(String customGl){
	  m_CustomGlDeferId = customGl;
  }
  ...
  public void setIsNoEmitido(String val){
	  isNoEmitido = val;
  }
  
  public boolean isNoEmitido(){
	  if(isNoEmitido.equalsIgnoreCase("Y"))
		  return true;
	  return false;
  }
  
  public boolean isDeferredOnReceipt() {
	    return m_isDeferredOnReceipt;
	  }

	  public void setIsDeferredOnReceipt(boolean m_isDeferredOnReceipt) {
	    this.m_isDeferredOnReceipt = m_isDeferredOnReceipt;
	  }
