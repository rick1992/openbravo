...
public class DocLine_SaleWithholding extends DocLine {
  static Logger log4jDocLine_Invoice = Logger.getLogger(DocLine_SaleWithholding.class);

  public DocLine_SaleWithholding(String DocumentType, String TrxHeader_ID, String TrxLine_ID) {
