...
public class PrintPurchaseInvoice extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintPurchaseInvoice.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.PURCHASEINVOICE;
    // The prefix PURCHASEINVOICE is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTPURCHASEINVOICE";
    ...
    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_20",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_20");
  }
