...
public class PrintFinancialAccount extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintFinancialAccount.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.FINANCIALACCOUNT;
    // The prefix PRINTFINANCIALACCOUNT is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTFINANCIALACCOUNT";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpfinFinancialAccountId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpfinFinancialAccountId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_6",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_6");
  }
