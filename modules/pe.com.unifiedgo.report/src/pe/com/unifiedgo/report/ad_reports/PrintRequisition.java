...
public class PrintRequisition extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintRequisition.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.REQUISITION;
    // The prefix REQUISITION is a fixed name based on the KEY of the
    // AD_PROCESS
    ...
    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_10",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_10");
  }
