...
public class PrintBillofExchangeToCollectionDocument extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintBillofExchangeToCollectionDocument.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.BILLOFEXCHANGETOCOLLECTIONDOC;
    // The prefix PRINTBILLOFEXCHANGETOCOLLECTIONDOC is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTBILLOFEXCHANGETOCOLLECTIONDOC";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoBoeToDiscountId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoBoeToDiscountId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_12",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_12");
  }
