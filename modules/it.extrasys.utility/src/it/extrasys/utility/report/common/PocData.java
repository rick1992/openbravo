...
public class PocData implements FieldProvider {
  ...
  public static PocData[] dummy(ConnectionProvider connectionProvider, int firstRegister,
      int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + "		select" + "			'' as document_id," + "			'' as docstatus,"
        + "			'' as ourreference," + "			'' as yourreference," + "			'' as salesrep_user_id,"
        + "			'' as salesrep_email," + "			'' as salesrep_name," + "			'' as bpartner_id,"
        + "			'' as bpartner_name," + "			'' as contact_user_id," + "			'' as contact_email,"
        + "			'' as contact_name," + "			'' as ad_user_id," + "			'' as user_email,"
        + "			'' as user_name," + "			'' as report_location" + "		from" + "			dual";
  ...
  public static PocData[] getContactDetailsForOrders(ConnectionProvider connectionProvider,
      String cOrderId) throws ServletException {
    return getContactDetailsForOrders(connectionProvider, cOrderId, 0, 0);
  }

  public static PocData[] getContactDetailsForOrders(ConnectionProvider connectionProvider,
      String cOrderId, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql
        + "		select"
        ...
        + "		where" + "			1=1";
    strSql = strSql
        + ((cOrderId == null || cOrderId.equals("")) ? ""
            : "              and c_order.c_order_id in          " + cOrderId);
  ...
  public static PocData[] getContactDetailsForInvoices(ConnectionProvider connectionProvider,
      String cInvoiceId) throws ServletException {
    return getContactDetailsForInvoices(connectionProvider, cInvoiceId, 0, 0);
  }

  public static PocData[] getContactDetailsForInvoices(ConnectionProvider connectionProvider,
      String cInvoiceId, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql
        + "		select"
        ...
        + "		where" + "			1=1";
    strSql = strSql
        + ((cInvoiceId == null || cInvoiceId.equals("")) ? ""
            : "              and c_invoice.c_invoice_id in          " + cInvoiceId);
  ...
  public static PocData[] getContactDetailsForShipments(ConnectionProvider connectionProvider,
      String mInoutId) throws ServletException {
    return getContactDetailsForShipments(connectionProvider, mInoutId, 0, 0);
  }

  public static PocData[] getContactDetailsForShipments(ConnectionProvider connectionProvider,
      String mInoutId, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql
        + "			select"
        ...
        + "			where" + "				1=1";
    strSql = strSql
        + ((mInoutId == null || mInoutId.equals("")) ? ""
            : "              and m_inout.m_inout_id in          " + mInoutId);
  ...
  public static PocData[] getContactDetailsForUser(ConnectionProvider connectionProvider,
      String adUserId) throws ServletException {
    return getContactDetailsForUser(connectionProvider, adUserId, 0, 0);
  }

  public static PocData[] getContactDetailsForUser(ConnectionProvider connectionProvider,
      String adUserId, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + "		select" + "			ad_user.ad_user_id," + "			ad_user.email as user_email,"
        + "			ad_user.name as user_name" + "		from" + "			ad_user" + "		where"
        + "			ad_user.ad_user_id = ?";
