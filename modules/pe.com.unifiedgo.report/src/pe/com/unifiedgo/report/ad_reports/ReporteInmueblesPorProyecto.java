...
public class ReporteInmueblesPorProyecto extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      /**/
      String strAD_Org_ID = vars.getGlobalVariable("inpOrgId", "ReporteInmueblesPorProyecto|OrgId",
          "");
      ...
      //if (vars.commandIn("XLS")) {
        printPageXLS(request, response, vars, strAD_Org_ID, strCProjectId);
      //}
  ...
  private void printPageXLS(HttpServletRequest request, HttpServletResponse response,
      VariablesSecureApp vars, String strAD_Org_ID, String strCProjectId) throws IOException, ServletException {

    String strOutput;
    String strReportName;

    ReporteInmueblesPorProyectoData[] data = null;

    try {
      data = ReporteInmueblesPorProyectoData.selectData(this, strAD_Org_ID, strCProjectId);
    } catch (OBException e) {
    ...
    if(vars.commandIn("PDF")){
    	strOutput = "pdf";
        strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteInmueblesPorProyecto.jrxml";
    }else{
    	strOutput = "xls";
        strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteInmueblesPorProyectoExcel.jrxml";
    }

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    String orgname = ReporteInmueblesPorProyectoData.selectOrg(this, strAD_Org_ID).toString();

    /* parameters */
    parameters.put("ORGANIZACION", ReporteInmueblesPorProyectoData.selectOrg(this, strAD_Org_ID));
    parameters.put("RUC", ReporteInmueblesPorProyectoData.selectRuc(this, strAD_Org_ID));
    parameters.put("PROYECTO", ReporteInmueblesPorProyectoData.selectProjectName(this, strCProjectId));
    parameters.put("DIRECCION", ReporteInmueblesPorProyectoData.selectProjectLocation(this, strCProjectId));
    parameters.put("ESTADO", ReporteInmueblesPorProyectoData.selectProjectStatus(this, strCProjectId));
  ...
  private void printPageDataSheet(HttpServletRequest request, HttpServletResponse response,
    ...
    ReporteInmueblesPorProyectoData[] dataItems = null;
    ...
    xmlDocument = xmlEngine.readXmlTemplate(
        "pe/com/unifiedgo/report/ad_reports/ReporteInmueblesPorProyecto", discard)
        .createXmlDocument();
    ...
    if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      ...
      ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReporteInmueblesPorProyecto", false,
      ...
      try {
        WindowTabs tabs = new WindowTabs(this, vars,
            "pe.com.unifiedgo.report.ad_reports.ReporteInmueblesPorProyecto");
        xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
        xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
        xmlDocument.setParameter("childTabContainer", tabs.childTabs());
        xmlDocument.setParameter("theme", vars.getTheme());
        NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
            "ReporteInmueblesPorProyecto.html", classInfo.id, classInfo.type, strReplaceWith,
            tabs.breadcrumb());
        xmlDocument.setParameter("navigationBar", nav.toString());
        LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
            "ReporteInmueblesPorProyecto.html", strReplaceWith);
       ...
       * "ReporteInmueblesPorProyecto"), Utility.getContext(this, vars, "#User_Client",
       * "ReporteInmueblesPorProyecto"), 0); comboTableData.fillParameters(null,
       * "ReporteInmueblesPorProyecto", ""); xmlDocument.setData("reportAD_Org_ID", "liststructure",
       * comboTableData.select(false)); } catch (Exception ex) { throw new ServletException(ex); }
       */

//      try {
//        dataItems = ReporteInmueblesPorProyectoData.getGlItems(this, strAD_Org_ID);
//
...
//      }
       ...
       * "ReporteInmueblesPorProyecto"), Utility.getContext(this, vars, "#User_Client",
       * "ReporteInmueblesPorProyecto"), 0); Utility.fillSQLParameters(this, vars, null,
       * comboTableData, "ReporteInmueblesPorProyecto", glitemId);
...
//        		  ReporteInmueblesPorProyectoData.getGlItems(this, strAD_Org_ID)));

      /* FIN Llenar controles */

      {
        OBError myMessage = vars.getMessage("ReporteInmueblesPorProyecto");
        vars.removeMessage("ReporteInmueblesPorProyecto");
        if (myMessage != null) {
