...
public class PrintGoodsTransfer extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintGoodsTransfer.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.GOODSTRANSFER;
    // The prefix GOODSTRANSFER is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTGOODSTRANSFER";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoTransferinoutId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoTransferinoutId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_14",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_14");
  }
