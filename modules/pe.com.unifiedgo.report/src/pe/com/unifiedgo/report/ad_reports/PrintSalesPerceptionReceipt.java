...
public class PrintSalesPerceptionReceipt extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintSalesPerceptionReceipt.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.SALESPERCEPTIONRECEIPT;
    // The prefix SALESPERCEPTIONRECEIPT is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTSALESPERCEPTIONRECEIPT";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoPercepSalesId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoPercepSalesId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_9",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_9");
  }
