...
public class SCO_Billofexchange_CBpartner extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      /*
       * HttpSession mysessions = request.getSession(); String[] mysess_array =
       * mysessions.getValueNames(); for (Integer i = 0; i < mysess_array.length; i++) {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strBPartner,
    ...
    String strUserRep;
    String DocBaseType = SCOBillofexchangeBPartnerData.docBaseType(this, strDocType);
    ...
    if (data == null || data.length == 0)
      ...
      // strUserRep = SCOBillofexchangeBPartnerData.userIdSalesRep(this, data[0].salesrepId);
      ...
      if (strPriceList.equalsIgnoreCase("")) {
        strPriceList = SCOBillofexchangeBPartnerData.defaultPriceList(this, strIsSOTrx,
            vars.getClient());
      }
      ...
      if (C_SpecialMethod != null && isMemo
          && C_SpecialMethod.compareTo("SCOBILLOFEXCHANGE") == 0) {
      ...
      if (data[0].emScoAvalId != null) {
        resultado.append("new Array(\"inpavalId\", \"" + data[0].emScoAvalId + "\"),");
      }
      // ///
      ...
      try {
        ComboTableData comboTableData = new ComboTableData(vars, this, "TABLE", "",
            "AD_User SalesRep", "",
            Utility.getContext(this, vars, "#AccessibleOrgTree", "SEInvoiceBPartner"),
            Utility.getContext(this, vars, "#User_Client", "SEInvoiceBPartner"), 0);
      ...
      if (tdv != null && tdv.length > 0) {
        ...
        resultado.append("null");
      resultado.append("\n),");
      String strWithHolding = SCOBillofexchangeBPartnerData.WithHolding(this, strBPartner);
