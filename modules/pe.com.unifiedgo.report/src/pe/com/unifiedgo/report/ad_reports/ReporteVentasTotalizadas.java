...
public class ReporteVentasTotalizadas extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (vars.commandIn("DEFAULT")) {
			...
			String mProductId = vars.getRequestGlobalVariable("inpmProductId",
					"ReporteVentasTotalizadas|M_Product_Id");
			...
			printPageDataSheet(request, response, vars, strAD_Org_ID,
					...
					mProductId, strmProductLineID, true);
			...
			printPageDataSheet(request, response, vars, strAD_Org_ID,
					strDocDate, strProyDate, strcBpartnetId, strVendedorId,
					mProductId, strmProductLineID, false);
	...
	private void printPageDataSheet(HttpServletRequest request,
			...
			String strIdProveedor, String strVendedorId, String mProductId,
			String strmProductLineID, boolean isFirstLoad) throws IOException,
			ServletException {
		...
		ReporteVentasTotalizadasData[] data = null;
		String strConvRateErrorMsg = "";

		String discard[] = { "discard" };

		xmlDocument = xmlEngine.readXmlTemplate(
				"pe/com/unifiedgo/report/ad_reports/ReporteVentasTotalizadas",
		...
		if (vars.commandIn("EDIT_HTML", "EDIT_PDF")) {
			...
			try {
				...
				data = ReporteVentasTotalizadasData
			...
			if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
				...
				if (data == null || data.length == 0) {
					...
					data = ReporteVentasTotalizadasData.set("0");
				} else {
		...
		if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
			ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
					"ReporteVentasTotalizadas", false, "", "",
			...
			try {
				WindowTabs tabs = new WindowTabs(this, vars,
						"pe.com.unifiedgo.core.ad_reports.ReporteVentasTotalizadas");
				...
				NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
						"ReporteVentasTotalizadas.html", classInfo.id,
						classInfo.type, strReplaceWith, tabs.breadcrumb());
				xmlDocument.setParameter("navigationBar", nav.toString());
				LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
						"ReporteVentasTotalizadas.html", strReplaceWith);
				xmlDocument.setParameter("leftTabs", lBar.manualTemplate());
			} catch (Exception ex) {
				throw new ServletException(ex);
			}
			{
				OBError myMessage = vars.getMessage("ReporteVentasTotalizadas");
				vars.removeMessage("ReporteVentasTotalizadas");
				if (myMessage != null) {
					xmlDocument
			...
			try {
				ComboTableData comboTableData = new ComboTableData(vars, this,
						...
						Utility.getContext(this, vars, "#User_Client",
								"ReporteVentasTotalizadas"), 0);
				Utility.fillSQLParameters(this, vars, null, comboTableData,
						"ReporteVentasTotalizadas", strAD_Org_ID);
			...
			String nombreProveedor = ReporteVentasTotalizadasData
			...
			ReporteVentasTotalizadasData[] datax = ReporteVentasTotalizadasData
					.select_vendedores(this, Utility.getContext(this, vars,
							"#User_Client", "ReporteVentasTotalizadas"));
			...
			xmlDocument.setParameter("productLineDescription",
					ReporteVentasTotalizadasData.selectPrdcProductgroup(this,
							strmProductLineID));

			xmlDocument.setParameter("mProduct", mProductId);
			xmlDocument.setParameter("productDescription",
					ReporteVentasTotalizadasData.selectMproduct(this,
							mProductId));
	...
	private void printPagePDF(HttpServletResponse response,
		...
		data = ReporteVentasTotalizadasData.select_cotizaciones_sinpedidos(
		...
		if (vars.commandIn("PDF")) {
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteVentasTotalizadas.jrxml";
			strTipoReporte = "pdf";

		} else {
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteVentasTotalizadasExcel.jrxml";
			strTipoReporte = "xls";
		}

		HashMap<String, Object> parameters = new HashMap<String, Object>();
		parameters.put("ruc",
				ReporteVentasTotalizadasData.selectRucOrg(this, strOrg));
		parameters.put("organizacion",
				ReporteVentasTotalizadasData.selectSocialName(this, strOrg));
