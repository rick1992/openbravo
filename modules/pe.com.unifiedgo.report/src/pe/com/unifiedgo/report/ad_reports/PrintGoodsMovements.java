...
public class PrintGoodsMovements extends PrintController {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.GOODSMOVEMENT;
    // The prefix GOODSMOVEMENT is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTGOODSMOVEMENT";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpmMovementId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpmMovementId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_16",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_16");
  }
