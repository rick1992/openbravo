...
public class ReportManager {
  ...
  private HashMap<String, Object> populateDesignParameters(VariablesSecureApp variables,
    ...
    DecimalFormat PriceFormat = Utility.getFormat(variables, "priceInform");
    designParameters.put("PRICEINFORM", PriceFormat);
    DecimalFormat QtyFormat = Utility.getFormat(variables, "qtyExcel");
    designParameters.put("QTYEXCEL", QtyFormat);
