...
public class PrintPurchaseWithholdingReceipt extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintPurchaseWithholdingReceipt.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.PURCHASEWITHHOLDINGRECEIPT;
    // The prefix PRINTPURCHASEWITHHOLDINGRECEIPT is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTPURCHASEWITHHOLDINGRECEIPT";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoPWithholdingReceiptId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoPWithholdingReceiptId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_4",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_4");
  }
