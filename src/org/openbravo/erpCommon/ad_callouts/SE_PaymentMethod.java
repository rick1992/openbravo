...
public class SE_PaymentMethod extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    try {
      ...
      info.addResult("inpemScoAutoRevertDeposit", paymentMethod.isScoAutoRevertDeposit() == null ? ""
          : paymentMethod.isScoAutoRevertDeposit());
      ...
      info.addResult("inpemScoAutoRevertWithdrawn", paymentMethod.isScoAutoRevertWithdrawn() == null ? ""
          : paymentMethod.isScoAutoRevertWithdrawn());
