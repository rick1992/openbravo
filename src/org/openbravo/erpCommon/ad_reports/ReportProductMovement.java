...
public class ReportProductMovement extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strPhyInventoryInOut = vars.getGlobalVariable("inpPhyInventoryInOut",
          "ReportProductMovement|phyInventoryInOut", "-1");
      printPageDataSheet(response, vars, strDateFrom, strDateTo, strcBpartnerId, strmProductId,
          ...
          strmAttributesetinstanceId, strInternalConsumption, strPhyInventoryInOut);
      ...
      String strPhyInventoryInOut = vars.getGlobalVariable("inpPhyInventoryInOut",
          "ReportProductMovement|phyInventoryInOut", "");
      ...
      String strInternalConsumption = vars.getRequestGlobalVariable("inpInternalConsumption",
          "ReportProductMovement|internalConsumption");
      String strPhyInventoryInOut = vars.getStringParameter("inpPhyInventoryInOut");
      setHistoryCommand(request, "DIRECT");
      printPageDataSheet(response, vars, strDateFrom, strDateTo, strcBpartnerId, strmProductId,
          strInout, strReturn, strInventory, strMovement, strProduction,
          strmAttributesetinstanceId, strInternalConsumption, strPhyInventoryInOut);
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
      ...
      String strPhyInventoryInOut) throws IOException, ServletException {
    ...
    ReportProductMovementData[] data6 = null;
    ...
    if (vars.commandIn("FIND", "DIRECT")) {
      ...
      if (strPhyInventoryInOut.equals("-1")) {
        data6 = ReportProductMovementData.selectPhyInventoryInOut(this, vars.getLanguage(),
            Utility.getContext(this, vars, "#User_Client", "ReportProductMovement"),
            Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportProductMovement"),
            strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"), strcBpartnerId,
            strmProductId, strmAttributesetinstanceId);
        if (data6 == null || data6.length == 0) {
          discard[6] = "selEliminar7";
          data6 = ReportProductMovementData.set();
        }
      } else {
        discard[6] = "selEliminar7";
        data6 = ReportProductMovementData.set();
    ...
    xmlDocument.setParameter("phyInventoryInOut", strPhyInventoryInOut);
    ...
    xmlDocument.setData("structure7", data6);
