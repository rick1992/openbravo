...
public class SL_Order_DocType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strSpecialdoctype = vars.getStringParameter("inpSsaSpecialdoctype");

      try {
        printPage(response, vars, strBPartner, strDocTypeTarget, strDocType, docNo, strOrder,
            strDescription, strTabId, strSpecialdoctype);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strBPartner,
      ...
      String strDescription, String strTabId, String strSpecialdoctype) throws IOException,
      ServletException {
    if (log4j.isDebugEnabled())
    ...
    if (strDocTypeTarget.equals(""))
      ...
      String PaymentRule = "4";
      String InvoiceRule = "I";
      String DeliveryRule = "O";
      ...
      if (documentType != null && documentType.getScoSpecialdoctype() != null) {
        resultado.append(", new Array(\"inpemSsaSpecialdoctype\", \""
            + documentType.getScoSpecialdoctype() + "\")\n");
      }

      //UGO FIX always do all or nothing for POS Order
      PaymentRule = "4";
      InvoiceRule = "I";
      DeliveryRule = "O";
