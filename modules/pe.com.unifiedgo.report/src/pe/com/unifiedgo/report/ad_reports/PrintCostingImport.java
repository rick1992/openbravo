...
public class PrintCostingImport extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintCostingImport.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.COSTINGIMPORT;
    // The prefix PRINTCOSTINGIMPORT is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTCOSTINGIMPORT";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsimImpCostingId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsimImpCostingId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_3",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_3");
  }
