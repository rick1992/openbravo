...
public class ParameterUtils {
  ...
  public static void setParameterValue(ParameterValue parameterValue, JSONObject requestValue) {
    try {
      ...
      log.error("Error trying to set value for paramter: " + parameterValue.getParameter().getName(), e);
    }
  }
  ...
  private static void setValue(ParameterValue parameterValue, String stringValue) {
    ...
    try {
      ...
      } else if (domainType.getClass().getSuperclass().equals(BigDecimalDomainType.class) || domainType.getClass().equals(LongDomainType.class)) {
  ...
  private static DomainType getParameterDomainType(Parameter parameter) {
    return ModelProvider.getInstance().getReference(parameter.getReference().getId()).getDomainType();
  }
  ...
  public static Object getJSExpressionResult(Map<String, String> parameters, HttpSession session, String expression) throws ScriptException {
