...
//Styling properties for the refresh convrate button in the navbar
isc.OBRefreshConvrate.addProperties({
  baseStyle: 'OBNavBarImgButton',
  height: 14,
  width: 36,
  src: OB.Styles.skinsPath + 'Default/org.openbravo.client.application/images/navbar/iconRefresh.png',
  showTitle: false,
  imageType: 'normal',
  layoutAlign: 'center',
  overflow: 'visible',
...
isc.OBAlertIcon.addProperties({
  ...
  alertIcon: {
    ...
    src: OB.Styles.skinsPath + 'Default/org.openbravo.client.application/images/navbar/iconAlert.gif'
  },
