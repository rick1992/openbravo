...
public class PrintAccountability extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintAccountability.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.ACCOUNTABILITY;
    // The prefix ACCOUNTABILITY is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTACCOUNTABILITY";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoRendicionCuentasId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoRendicionCuentasId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_11",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_11");
  }
