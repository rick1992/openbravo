...
public class PrintPurchasePrepayment extends PrintController {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.PURCHASEPREPAYMENT;
    // The prefix PRINTPURCHASEPREPAYMENT is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTPURCHASEPREPAYMENT";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoPrepaymentId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpscoPrepaymentId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_21",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_21");
  }
