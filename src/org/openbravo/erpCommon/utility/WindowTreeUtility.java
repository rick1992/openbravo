...
public class WindowTreeUtility {
  ...
  public static WindowTreeData[] getTreeTest(ConnectionProvider conn, VariablesSecureApp vars,
	      String TreeType, String TreeID, boolean editable, String strParentID, String strNodeId,
	      String strTabID) throws ServletException {
	    if (log4j.isDebugEnabled())
	      log4j.debug("WindowTreeUtility.getTree() - TreeID: " + TreeID);
   ...
   */
  public static String addNodeTest(String name, 
	        String strOnClick,
	      String strOnDblClick, boolean hasChilds, String nodeId) {
	    if (log4j.isDebugEnabled())
	      log4j.debug("WindowTreeUtility.addNodeElement() - name: " + name);
	    StringBuffer element = new StringBuffer();
	    strOnClick=null;
	    strOnDblClick=nodeId;
	    ...
	    // tree but click action is disabled
	      ...
	      //element.append(">").append("<table border=\"2px\"><tr><td>").append(name).append("</td></tr></table>").append("</a>");
	      //element.append(">").append("<div>").append("dddd").append("</div>").append("</a>");
	      //element.append(">").append("simon").append("</a>");
	      //element.append(">").append("<table border=\"2px\"><tr><td>").append("dfdfd").append("</td></tr></table>").append("</a>");
	    //  element.append(">").append(StringEscapeUtils.escapeHtml(name)).append("</a>\n");
	      
	    return element.toString();
	  }
  
  public static String addNodeTest2(String name, 
	        String strOnClick,
	      String strOnDblClick, boolean hasChilds, String nodeId) {
	    if (log4j.isDebugEnabled())
	      log4j.debug("WindowTreeUtility.addNodeElement() - name: " + name);
  ...
  public static String addNodeElement(String name, String description, String target,
    ...
    if (isSummary) {
      element
          ...
          .append("\"")
          .append(
              (nodeId.equals("0") ? " noDrag=\"true\" noSiblings=\"false\" noDelete=\"true\" noRename=\"true\" "
                  : "")).append(">\n");
