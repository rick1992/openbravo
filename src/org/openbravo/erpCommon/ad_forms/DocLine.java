...
public class DocLine {
  ...
  public String m_Record_Id3 = "";
  public String m_AD_Table3_Id = "";

  public String m_EEFF_Patrimchange_ID = "";
  public String m_EEFF_Cashflow_ID = "";
  public String m_Other_Currency_ID = "";
  public String m_Reeval_Currency_ID = "";

  public DocLine(DocLine source) {
    p_DocumentType = source.p_DocumentType;
    m_TrxHeader_ID = source.m_TrxHeader_ID;
    m_TrxLine_ID = source.m_TrxLine_ID;
  ...
  public void copyInfo(DocLine source) {
    m_Record_Id3 = source.m_Record_Id3;
    m_EEFF_Patrimchange_ID = source.m_EEFF_Patrimchange_ID;
    m_EEFF_Cashflow_ID = source.m_EEFF_Cashflow_ID;
    m_Reeval_Currency_ID = source.m_Reeval_Currency_ID;
    m_AD_Table3_Id = source.m_AD_Table3_Id;
