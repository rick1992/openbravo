...
public class SCO_Transferinout_DocType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strSCOTransferinoutId = vars.getStringParameter("inpscoBillofexchangeId");
      String strDescription = vars.getStringParameter("inpdescription");
      String strTabId = vars.getStringParameter("inpTabId");

      try {
        printPage(response, vars, strDocTypeTarget, strDocType, docNo, strSCOTransferinoutId, strDescription, strTabId);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strDocTypeTarget, String strDocType, String docNo, String strSCOTransferinoutId, String strDescription, String strTabId) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
    ...
    if (strDocTypeTarget.equals(""))
      ...
      resultado.append("var calloutName='SCO_Transferinout_DocType';\n\n");
      ...
      SCOTransferinoutDocTypeData[] data = null;

      if (!newDocNo && !"0".equals(strDocType)) {
        data = SCOTransferinoutDocTypeData.select(this, strDocType);
      ...
      SCOTransferinoutDocTypeData[] dataNew = SCOTransferinoutDocTypeData.select(this, strDocTypeTarget);
      if (dataNew != null && dataNew.length > 0) {
        ...
        if (DocSubTypeSO == null)
          DocSubTypeSO = "--";
        String strOldDocTypeTarget = SCOTransferinoutDocTypeData.selectOldDocSubType(this, strSCOTransferinoutId);
        if (!DocSubTypeSO.equals("OB") && strOldDocTypeTarget.equals("OB")) {
          String strOldDocNo = SCOTransferinoutDocTypeData.selectOldDocNo(this, strSCOTransferinoutId);
        ...
        if (dataNew[0].isdocnocontrolled.equals("Y")) {
          if (!newDocNo && !AD_Sequence_ID.equals(dataNew[0].adSequenceId) && !SCOTransferinoutDocTypeData.selectOldDocTypeTargetId(this, strSCOTransferinoutId).equalsIgnoreCase(strDocTypeTarget))
            newDocNo = true;
          if (newDocNo) {
