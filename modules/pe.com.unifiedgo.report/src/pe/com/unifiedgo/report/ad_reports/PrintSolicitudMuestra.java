...
public class PrintSolicitudMuestra extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintSolicitudMuestra.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.REQUERIMIENTOREPOSICION;
    // The prefix PRINTREQUERIMIENTOREPOSICION is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTREQUERIMIENTOREPOSICION";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpswaRequerimientoReposicionId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpswaRequerimientoReposicionId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_24",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_24");
  }
