    ...
    eventDragTargetDefaults: {
        ...
        dragResizeMove : function () {
            ...
            if (endDate.getTime() <= startDate.getTime()) {
                ...
                if (((props._leftDrag || props._topDrag) && cal.shouldDisableDate(startDate, view)) ||
                    ((props._rightDrag || props._bottomDrag) && cal.shouldDisableDate(testEndDate, view))) {
    ...
    */
    ...
    drawZones : function () {
        ...
        for (var i=0; i<rangeZones.length; i++) {
            ...
            canvas.renderEvent(0, left, right-left, this.body.getScrollHeight());
