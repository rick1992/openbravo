...
public class UndoManualTransTaxJournal extends DalBaseProcess {
  public void doExecute(ProcessBundle bundle) throws Exception {
    try {
      ...
      try {
        ...
        e.printStackTrace();
        throw new OBException("@SCO_UndoManualTaxJournalDELGLJournalError@");
      }
