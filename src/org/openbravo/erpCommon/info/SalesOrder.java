...
public class SalesOrder extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strCopyTo_COrderID = vars.getSessionValue("CopyFromPOOrder|C_Order_ID");
      ...
      printGridData(response, vars, strName, strBpartnerId, strDateFrom, strDateTo, strDescription,
          ...
          strNewFilter, strOrg, strCopyTo_COrderID);
    } else
      pageError(response);
  }
  ...
  private void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strName,
      ...
      String strCopyTo_COrderID) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
    ...
    if (headers != null) {
      Order ord = OBDal.getInstance().get(Order.class, strCopyTo_COrderID);
      String ord_specialdoctype = "", ord_currency_id = "", ord_org_id = "";
      if (ord != null) {
        ord_specialdoctype = ord.getSsaSpecialdoctype();
        ord_currency_id = ord.getCurrency().getId();
        ord_org_id = ord.getOrganization().getId();
      }
      ...
      try {
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) {
          ...
          strNumRows = SalesOrderData.countRows(this, rownum,
              Utility.getContext(this, vars, "#User_Client", "SalesOrder"),
              Utility.getSelectorOrgs(this, vars, strOrg), ord_specialdoctype, ord_currency_id,
              ord_org_id, strName, strDescription, strOrder, strBpartnerId, strDateFrom,
              DateTimeData.nDaysAfter(this, strDateTo, "1"), strCal1, strCalc2, pgLimit, oraLimit1,
              oraLimit2);
        ...
        if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
          ...
          data = SalesOrderData.select(this, "ROWNUM",
              Utility.getContext(this, vars, "#User_Client", "SalesOrder"),
              Utility.getSelectorOrgs(this, vars, strOrg), ord_specialdoctype, ord_currency_id, ord_org_id, 
              strName, strDescription, strOrder, strBpartnerId, strDateFrom,
              DateTimeData.nDaysAfter(this, strDateTo, "1"), strCal1, strCalc2, strOrderBy,
              oraLimit, "");
        } else {
