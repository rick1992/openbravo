...
public class PrintBOMProduction extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintGoodsMovements.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = DocumentType.BOMPRODUCTION;
    // The prefix BOMPRODUCTION is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTBOMPRODUCTION";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpmProductionId_R");
    if (strDocumentId.equals("")) {
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpmProductionId");
    }

    post(request, response, vars, documentType, sessionValuePrefix, strDocumentId, "_17",
        "pe/com/unifiedgo/report/ad_reports/PrintOptions_17");
  }
