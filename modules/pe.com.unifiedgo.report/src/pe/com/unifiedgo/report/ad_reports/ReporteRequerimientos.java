...
public class ReporteRequerimientos extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocDate = vars.getGlobalVariable("inpDocDate", "ReporteRequerimientos|docDate",
          SREDateTimeData.today(this));
      String strProyDate = vars.getGlobalVariable("inpProyDate", "ReporteRequerimientos|proyDate",
          SREDateTimeData.tomorrow(this));
      String strAD_Org_ID = vars.getGlobalVariable("inpadOrgId", "ReporteRequerimientos|AD_Org_ID",
          "");
      String strcBpartnetId = vars.getGlobalVariable("inpcBPartnerId",
          "ReporteRequerimientos|CB_PARTNER_ID", "");

      String strProjectId = vars.getGlobalVariable("inpProjectId",
          "ReporteRequerimientos|project_id", "");

      printPageDataSheet(request, response, vars, strDocDate, strProyDate, strcBpartnetId,
          strAD_Org_ID, true, strProjectId);
      ...
      String strcBpartnetId = vars.getStringParameter("inpProjectId");

      printPageDataSheet(request, response, vars, strDocDate, strProyDate, strcBpartnetId,
          strAD_Org_ID, false, strcBpartnetId);
    } else
    ...
    if (vars.commandIn("PDF", "XLS")) {
      ...
      if (vars.commandIn("PDF")) {
        ...
        printPageXLS(request, response, vars, strDocDate, strProyDate, strcBpartnetId,
            strAD_Org_ID);
      }
  ...
  private void printPagePDF(HttpServletRequest request, HttpServletResponse response,
    ...
    ReporteRequerimientosData[] data = null;

    /*
     * try { data = ReporteRequerimientosData.select(strAD_Org_ID,
     * vars.getSessionValue("#AD_CLIENT_ID"), strDocDate, strProyDate, strC_BPartner_ID,
     * vars.getSessionValue("#AD_USER_ID")); } catch (OBException e) { advisePopUp(request,
     * response, "WARNING", Utility.messageBD(this, "ProcessStatus-W", vars.getLanguage()),
    ...
    if (vars.commandIn("PDF")) {
      strOutput = "pdf";
      strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteRequerimientos.jrxml";
    } else {
      strOutput = "xls";
      strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteRequerimientosExcel.jrxml";
    }

    HashMap<String, Object> parameters = new HashMap<String, Object>();

    parameters.put("ORGANIZACION",
        ReporteRequerimientosData.selectOrganization(this, strAD_Org_ID));
    parameters.put("RUC_ORGANIZACION",
        ReporteRequerimientosData.selectRucOrganization(this, strAD_Org_ID));
    parameters.put("TERCERO", ReporteRequerimientosData.selectBPartner(this, strC_BPartner_ID));
    parameters.put("RUC_TERCERO",
        ReporteRequerimientosData.selectRucBPartner(this, strC_BPartner_ID));
  ...
  private void printPageDataSheet(HttpServletRequest request, HttpServletResponse response,
      VariablesSecureApp vars, String strDocDate, String strProyDate, String strC_BPartner_ID,
      String strAD_Org_ID, boolean isFirstLoad, String strProjectId)
      throws IOException, ServletException {
    if (log4j.isDebugEnabled())
    ...
    xmlDocument = xmlEngine
        .readXmlTemplate("pe/com/unifiedgo/report/ad_reports/ReporteRequerimientos", discard)
        .createXmlDocument();
    ...
    if (vars.commandIn("EDIT_HTML", "EDIT_PDF")) {
       ...
       * 
       * } catch (ServletException ex) { myMessage = Utility.translateError(this, vars,
      ...
      if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
        ...
        if (data == null || data.length == 0) {
          ...
          // data = ReporteRequerimientosData.set();
        } else {
    ...
    if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      ...
      ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReporteRequerimientos", false, "",
      ...
      try {
        WindowTabs tabs = new WindowTabs(this, vars,
            "pe.com.unifiedgo.report.ad_reports.ReporteRequerimientos");
        xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
        xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
        xmlDocument.setParameter("childTabContainer", tabs.childTabs());
        xmlDocument.setParameter("theme", vars.getTheme());
        NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
            "ReporteRequerimientos.html", classInfo.id, classInfo.type, strReplaceWith,
            tabs.breadcrumb());
        xmlDocument.setParameter("navigationBar", nav.toString());
        LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ReporteRequerimientos.html",
            strReplaceWith);
      ...
      {
        OBError myMessage = vars.getMessage("ReporteRequerimientos");
        vars.removeMessage("ReporteRequerimientos");
        if (myMessage != null) {
      ...
      xmlDocument.setParameter("paramBPartnerDescription",
          ReporteRequerimientosData.selectBPartner(this, strC_BPartner_ID));

      xmlDocument.setParameter("paramProjectId", strProjectId);
      xmlDocument.setParameter("paramProjectDescription",
          ReporteRequerimientosData.selectProjectName(this, strProjectId));

      try {
        ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "AD_Org_ID", "",
            "0C754881EAD94243A161111916E9B9C6",
            Utility.getContext(this, vars, "#AccessibleOrgTree", "ReporteRequerimientos"),
            Utility.getContext(this, vars, "#User_Client", "ReporteRequerimientos"), 0);
        Utility.fillSQLParameters(this, vars, null, comboTableData, "ReporteRequerimientos",
            strAD_Org_ID);
