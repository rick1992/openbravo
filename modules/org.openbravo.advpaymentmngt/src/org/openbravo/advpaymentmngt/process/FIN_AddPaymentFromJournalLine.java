  ...
  protected void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      FIN_Payment payment = dao.getNewPayment(isReceipt, journalLine.getOrganization(),
          ...
          journalLine.getDebit().subtract(journalLine.getCredit()).abs().toString(), date, null,
          journalLine.getCurrency(), null, null, null);

      // Add Payment Details
      FIN_AddPayment.saveGLItem(payment,
          journalLine.getDebit().subtract(journalLine.getCredit()).abs(), glItem, bPartner,
          ...
          journalLine.getScoInternalDoc(), journalLine.getScoCInvoice());
