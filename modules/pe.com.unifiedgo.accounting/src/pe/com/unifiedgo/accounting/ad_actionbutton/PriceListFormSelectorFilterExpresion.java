...
public class PriceListFormSelectorFilterExpresion implements FilterExpression {
  ...
  public String getExpression(Map<String, String> requestMap) {
    ...
    String type = requestMap.get("type") != null ? requestMap.get("type") : "";
    ...
    if (type.compareTo("sales") == 0) {
      if (whereClause.length() != 0)
        whereClause.append(" and ");
      whereClause.append("e.salesPriceList = true");
