...
public class Transactions extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT") || vars.commandIn("EDIT")) {
      ...
      if ("".equals(strFinFinancialAccountId))
        response.sendRedirect(getDireccion() + "/" + FormatUtilities.replace(windowNameEnUS) + "/"
      ...
      if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(),
        ...
        vars.setSessionValue("Posted|path", getDireccion() + request.getServletPath());
        vars.setSessionValue("Posted|windowId", windowId);
        vars.setSessionValue("Posted|tabName", "Header");
        response.sendRedirect(getDireccion() + "/ad_actionButton/Posted.html");
      }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    xmlDocument.setParameter("windowPath", Utility.getTabURL(tabId, "E", true, getDireccion()));
