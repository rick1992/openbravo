...
public class ReporteVersusCompras extends
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (vars.commandIn("DEFAULT")) {
			...
			vars.setSessionValue(
					"ReporteVersusCompras.initRecordNumber",
					"0");
	...
	private void printPageDataSheet(HttpServletResponse response,
		...
		ReporteVersusComprasData[] data = null;
		String strPosition = "0";
		
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"ReporteVersusCompras", false, "", "",
				"", false, "ad_reports",
...
//					false,
//					false,
//					"submitCommandForm('XLS', false, null, 'ReporteVersusCompras.xls', 'EXCEL');return false;");
			xmlDocument = xmlEngine
					.readXmlTemplate(
							"pe/com/unifiedgo/report/ad_reports/ReporteVersusCompras",
							discard).createXmlDocument();
			data = ReporteVersusComprasData.set("0");
			data[0].rownum = "0";
		}
		...
		}
		{
			OBError myMessage = vars
					.getMessage("ReporteVersusCompras");
			vars.removeMessage("ReporteVersusCompras");
			if (myMessage != null) {
		...
		xmlDocument.setParameter("paramPeriodosArray", Utility.arrayInfinitasEntradas("idperiodo;periodo;fechainicial;fechafinal;idorganizacion","arrPeriodos",
	  			ReporteVersusComprasData
				.select_periodos(this)));
		vars.setSessionValue(
				"ReporteVersusCompras|Record", strRecord);
		vars.setSessionValue(
				"ReporteVersusCompras|Table", strTable);

		xmlDocument.setParameter("mProduct", mProductId);
		xmlDocument.setParameter("productDescription", ReporteVersusComprasData.selectMproduct(this, mProductId));

		xmlDocument.setParameter("BPartnerId", strBPartnerId);
		xmlDocument.setParameter("BPartnerDescription", ReporteVersusComprasData.selectBpartner(this, strBPartnerId));
	...
	private void printPagePDF(HttpServletRequest request,HttpServletResponse response,
		...
		List<VersusLine> listData = new ArrayList<VersusLine>();
		...
		listData =VersusCompras 
				.getVersusCompras(this, dateIni, dateFin, strOrg, strBPartnerId, mProductId);
		
			      /////////////////////////////
//		listData = new ArrayList<VersusLine>();
//		
//		 VersusLine e= new VersusLine();
...
//		
	      ...
	      data= new ReporteVersusComprasData [listData.size()];
	      
	      for(int i=0;i<listData.size();i++){
	    	  VersusLine o=listData.get(i);
	    	  ReporteVersusComprasData a = new ReporteVersusComprasData();
		...
		String strSubtitle = (Utility.messageBD(this, "LegalEntity",
				vars.getLanguage()) + ": ")
				+ ReporteVersusComprasData.selectCompany(
						this, vars.getClient())
				+ "\n"
				+ "RUC:"
				+ ReporteVersusComprasData.selectRucOrg(
						this, strOrg) + "\n";

		if (!("0".equals(strOrg)))
			strSubtitle += (Utility.messageBD(this, "OBUIAPP_Organization",
					vars.getLanguage()) + ": ")
					+ ReporteVersusComprasData.selectOrg(
							this, strOrg) + "\n";
		...
		if (vars.commandIn("PDF")) {
			strOutput = "pdf";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteVersusCompras.jrxml";
		} else {
			strOutput = "xls";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteVersusCompras.jrxml";
		}
		...
		parameters.put("Ruc", ReporteVersusComprasData
		...
		renderJR(vars, response, strReportName,
				"Reporte de Versus de Compras", strOutput,
	...
	public String getServletInfo() {
		return "Servlet ReporteVersusCompras. This Servlet was made by Pablo Sarobe modified by everybody";
