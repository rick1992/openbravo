...
public class SCO_Pwithho_Rec_Line_DocTypeRef extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    if (strInvoiceRefId != null && !strInvoiceRefId.equals("")) {
      ...
      if (invoice.getTransactionDocument().getId().equals(strDocTypeRefId) && invoice.getDocumentStatus().equals("CO") && invoice.isPaymentComplete() == false && invoice.getBusinessPartner().getId().equals(strCBPartnerId)) {
    ...
    if (searchForMatch) {
      ...
      invoice_c.add(Restrictions.eq(Invoice.PROPERTY_PAYMENTCOMPLETE, false));
