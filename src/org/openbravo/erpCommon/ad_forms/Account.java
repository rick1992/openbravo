...
public final class Account implements Serializable {
  ...
  public Account(ConnectionProvider conn, String schemaId, String accountId) throws ServletException {
	    C_ValidCombination_ID = "";
	    C_AcctSchema_ID = "";
	    AD_Client_ID = "";
	    AD_Org_ID = "";
	    ...
	    if (accountId != null && accountId.equals("")) {
	      ...
	      load(null, conn, schemaId, accountId);
	      return;
	    }
	  }

  
  public void load(Connection conn1, ConnectionProvider conn, String schemaId, String accountId)
      throws ServletException {
    AccountData[] data = null;
    try {
      log4jAccount.debug("C_ValidCombination_ID: " + C_ValidCombination_ID);
      if (conn1 == null)
        data = AccountData.select(conn, schemaId, accountId);
      else
        data = AccountData.selectConnection(conn1, conn, schemaId, accountId);
      if (data.length > 0) {
        ...
        log4jAccount.warn("Account.getAccount - " + accountId + " not found");
      }
  ...
  public static Account getAccount(ConnectionProvider conn, String schemaId, String accountId)
	      throws ServletException {
	    return new Account(conn, schemaId, accountId);
	  }
