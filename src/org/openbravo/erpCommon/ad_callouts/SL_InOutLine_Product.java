...
public class SL_InOutLine_Product extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    if(strIsSOTrx.equals("N")){
    	...
    	Warehouse warehouse = OBDal.getInstance().get(Warehouse.class, strWarehouse.trim());
    	if(warehouse.getSwaReceiptLocator() != null)
    	info.addResult("inpmLocatorId", warehouse.getSwaReceiptLocator().getId());
    }
