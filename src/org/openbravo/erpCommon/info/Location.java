...
public class Location extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    } else if (vars.commandIn("OBTENER_ARRAY2")) {
      String strcCountryId = vars.getStringParameter("inpcCountryId");
      String strcRegionId = vars.getStringParameter("inpCRegionId");
      String strWindow = vars.getSessionValue("Location.inpwindowId");
      printPageF3(response, vars, strcCountryId, strcRegionId, strWindow);

    } else if (vars.commandIn("OBTENER_ARRAY3")) {
      String strcCountryId = vars.getStringParameter("inpcCountryId");
      String strcRegionId = vars.getStringParameter("inpCRegionId");
      String strscrProvinceId = vars.getStringParameter("inpScrProvinceId");
      String strWindow = vars.getSessionValue("Location.inpwindowId");

      printPageF4(response, vars, strcCountryId, strcRegionId, strscrProvinceId, strWindow);
  ...
  private LocationSearchData getEditVariables(VariablesSecureApp vars) {
    ...
    data.scrProvinceId = vars.getStringParameter("inpScrProvinceId");
  ...
  private void printPageKey(HttpServletResponse response, VariablesSecureApp vars, LocationSearchData data) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
  ...
  private void printPageSheet(HttpServletResponse response, VariablesSecureApp vars, String strcLocationId, String strWindow, String stradOrgId) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
    ...
    if (strcLocationId.equals("")) {
      ...
      // Set default country
      String strDefaultCountry = LocationSearchData.selectDefaultCountry(this, vars.getOrg(), Utility.getContext(this, vars, "#User_Client", strWindow));
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "SCR_Province_ID", "", "E4055D4F453E44A4ACECA9B099DEDC22", Utility.getReferenceableOrg(vars, vars.getOrg()), Utility.getContext(this, vars, "#User_Client", strWindow), 0);
      Utility.fillSQLParameters(this, vars, data[0], comboTableData, strWindow, data[0].scrProvinceId);
      xmlDocument.setData("reportProvince", "liststructure", comboTableData.select(false));
      comboTableData = null;
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
    ...
    try {
      xmlDocument.setData("reportCity", "liststructure", LocationSearchData.selectCityByProvince(this, data[0].scrProvinceId));
      FieldProvider[] fp = LocationSearchData.selectCityByProvince(this, data[0].scrProvinceId);
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
  ...
  private void printPageF2(HttpServletResponse response, VariablesSecureApp vars, String strcCountryId, String strWindow) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
    ...
    // Getcountry; default
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_Region_ID", "", "C_Region of Country", Utility.getContext(this, vars, "#AccessibleOrgTree", strWindow), Utility.getContext(this, vars, "#User_Client", strWindow), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, strWindow, "");
      xmlDocument.setParameter("array", Utility.arrayEntradaSimple("regions", comboTableData.select(false)));

      FieldProvider[] fpP = new FieldProvider[0];
      xmlDocument.setParameter("arrayP", Utility.arrayEntradaSimple("provinces", fpP));

      FieldProvider[] fp = new FieldProvider[0];
      xmlDocument.setParameter("arrayC", Utility.arrayEntradaSimple("cities", fp));
      comboTableData = null;
  ...
  private void printPageF3(HttpServletResponse response, VariablesSecureApp vars, String strcCountryId, String strcRegionId, String strWindow) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
      log4j.debug("Output: F3 Locations seeker");
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/info/Location_F3").createXmlDocument();

    try {
      xmlDocument.setParameter("arrayP", Utility.arrayEntradaSimple("provinces", LocationSearchData.selectProvinceByRegion(this, strcRegionId)));
      FieldProvider[] fp = new FieldProvider[0];
      xmlDocument.setParameter("arrayC", Utility.arrayEntradaSimple("cities", fp));
      // xmlDocument.setParameter("arrayC", Utility.arrayEntradaSimple("cities",
      // LocationSearchData.selectCityByRegion(this, strcRegionId)));
  ...
  private void printPageF4(HttpServletResponse response, VariablesSecureApp vars, String strcCountryId, String strcRegionId, String strScrProvinceId, String strWindow) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
      log4j.debug("Output: F3 Locations seeker");
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/info/Location_F4").createXmlDocument();

    try {
      xmlDocument.setParameter("arrayC", Utility.arrayEntradaSimple("cities", LocationSearchData.selectCityByProvince(this, strScrProvinceId)));
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
