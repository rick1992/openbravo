...
public class PPriceListFormSelectorFilterExpresion implements FilterExpression {
  ...
  public String getExpression(Map<String, String> requestMap) {
    ...
    whereClause.append("e.salesPriceList = false ");
    whereClause.append("and e.active = true ");
    ...
    if (restrictorg) {
      ...
      if (!orgList.isEmpty()) {
        whereClause.append("and e.organization.id in (" + orgList + ")");
      } else {
        whereClause.append("and e.organization.id in ('')");
      }
    }
