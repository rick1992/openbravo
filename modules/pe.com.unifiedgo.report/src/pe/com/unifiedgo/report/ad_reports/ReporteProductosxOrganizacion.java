...
public class ReporteProductosxOrganizacion extends
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (vars.commandIn("DEFAULT")) {
			String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"ReporteProductosxOrganizacion|DateFrom", "");
			String strDateTo = vars.getGlobalVariable("inpDateTo",
					"ReporteProductosxOrganizacion|DateTo", "");
			String strOrg = vars.getGlobalVariable("inpOrg",
					"ReporteProductosxOrganizacion|Org", "0");
			String strRecord = vars.getGlobalVariable("inpRecord",
					"ReporteProductosxOrganizacion|Record", "");
			String strTable = vars.getGlobalVariable("inpTable",
					"ReporteProductosxOrganizacion|Table", "");
			...
			vars.setSessionValue(
					"ReporteProductosxOrganizacion.initRecordNumber",
					"0");
	...
	private void printPageDataSheet(HttpServletResponse response,
		...
		ReporteProductosxOrganizacionData[] data = null;
		String strPosition = "0";
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"ReporteProductosxOrganizacion", false, "", "",
				"", false, "ad_reports",
...
//					false,
//					false,
//					"submitCommandForm('XLS', false, null, 'ReporteProductosxOrganizacion.xls', 'EXCEL');return false;");
			xmlDocument = xmlEngine
					.readXmlTemplate(
							"pe/com/unifiedgo/report/ad_reports/ReporteProductosxOrganizacion",
							discard).createXmlDocument();
			data = ReporteProductosxOrganizacionData.set("0");
			data[0].rownum = "0";
		}
		...
		try {
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"ReporteProductosxOrganizacion.html",
		...
		}
		{
			OBError myMessage = vars
					.getMessage("ReporteProductosxOrganizacion");
			vars.removeMessage("ReporteProductosxOrganizacion");
			if (myMessage != null) {
		...
		vars.setSessionValue(
				"ReporteProductosxOrganizacion|Record", strRecord);
		vars.setSessionValue(
				"ReporteProductosxOrganizacion|Table", strTable);
	...
	private void printPagePDF(HttpServletRequest request,HttpServletResponse response,
		...
		ArrayList<ReporteProductosxOrganizacionData> listData = new ArrayList<ReporteProductosxOrganizacionData>();

		String strTreeOrg = TreeData.getTreeOrg(this, vars.getClient());
		String strOrgFamily = getFamily(strTreeOrg, strOrg);

		data = ReporteProductosxOrganizacionData
				.selectProductos(this, Utility.getContext(this, vars,
						"#User_Client",
						"ReporteProductosxOrganizacion"),
						strOrgFamily);
		...
		String strSubtitle = (Utility.messageBD(this, "LegalEntity",
				vars.getLanguage()) + ": ")
				+ ReporteProductosxOrganizacionData.selectCompany(
						this, vars.getClient())
				+ "\n"
				+ "RUC:"
				+ ReporteProductosxOrganizacionData.selectRucOrg(
						this, strOrg) + "\n";

		if (!("0".equals(strOrg)))
			strSubtitle += (Utility.messageBD(this, "OBUIAPP_Organization",
					vars.getLanguage()) + ": ")
					+ ReporteProductosxOrganizacionData.selectOrg(
							this, strOrg) + "\n";
		...
		if (vars.commandIn("PDF")) {
			strOutput = "pdf";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteProductosxOrganizacion.jrxml";
		} else {
			strOutput = "xls";
			strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteProductosxOrganizacionExcel.jrxml";
		}

		HashMap<String, Object> parameters = new HashMap<String, Object>();
		// parameters.put("Subtitle", strSubtitle);
		parameters.put("Ruc", ReporteProductosxOrganizacionData
				.selectRucOrg(this, strOrg));
		parameters.put("organizacion",
				ReporteProductosxOrganizacionData
	...
	public String getServletInfo() {
		return "Servlet ReporteProductosxOrganizacion. This Servlet was made by Pablo Sarobe modified by everybody";
