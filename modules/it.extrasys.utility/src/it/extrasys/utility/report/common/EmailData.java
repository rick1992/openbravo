...
public class EmailData implements FieldProvider {
  ...
  public static EmailData[] getEmail(ConnectionProvider connectionProvider, String emailId)
  ...
  public static EmailData[] getEmail(ConnectionProvider connectionProvider, String emailId,
    ...
    String strSql = "";
    strSql = strSql + "		select			" + "			C_POC_EMAIL_ID, " + "			AD_CLIENT_ID ,"
        + "			AD_ORG_ID ," + "			ISACTIVE ," + "			CREATED ," + "			CREATEDBY, " + "			UPDATED ,"
        + "			UPDATEDBY, " + "			EMAIL_TYPE," + "			ADDRESS_FROM ," + "			ADDRESS_TO ,"
        + "			ADDRESS_CC ," + "			ADDRESS_BCC ," + "			DATEOFEMAIL, " + "			SUBJECT ,"
        + "			BODY ," + "			C_BPARTNER_ID" + "		from" + "			C_POC_EMAIL" + "		where" + "			1=1";
    strSql = strSql
        + ((emailId == null || emailId.equals("")) ? ""
            : "              and C_POC_EMAIL.C_POC_EMAIL_ID in          " + emailId);
  ...
  public static int insertEmail(Connection conn, ConnectionProvider connectionProvider,
      String bmPocEmailId, String adClientId, String adOrgId, String adUserId, String type,
      String from, String to, String cc, String bcc, String dateOfEmail, String subject,
      String body, String cBpartnerId) throws ServletException {
    String strSql = "";
    strSql = strSql + "        INSERT INTO" + "        	C_POC_EMAIL" + "        	("
        + "				C_POC_EMAIL_ID, " + "				AD_CLIENT_ID ," + "				AD_ORG_ID ," + "				ISACTIVE ,"
        + "				CREATED ," + "				CREATEDBY, " + "				UPDATED ," + "				UPDATEDBY, "
        + "				EMAIL_TYPE," + "				ADDRESS_FROM ," + "				ADDRESS_TO ," + "				ADDRESS_CC ,"
        + "				ADDRESS_BCC ," + "				DATEOFEMAIL, " + "				SUBJECT ," + "				BODY ,"
        + "				C_BPARTNER_ID" + "        	)" + "        	VALUES" + "        	(" + "        		?,"
        + "        		?," + "        		?, " + "        		'Y', " + "        		now(), "
        + "        		?," + "				now()," + "				?," + "				?," + "				?," + "				?," + "				?,"
    ...
    try {
      ...
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, bmPocEmailId);
      iParameter++;
      ...
      UtilSql.setValue(st, iParameter, 12, null, adUserId);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, type);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, from);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, to);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, cc);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, bcc);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, dateOfEmail);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, subject);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, body);
      iParameter++;
  ...
  public static int insertEmailUser(Connection conn, ConnectionProvider connectionProvider,
      String bmPocEmailUserId, String adClientId, String adOrgId, String adUserId, String type,
      String bmPocEmailId, String email_adUserId) throws ServletException {
    String strSql = "";
    strSql = strSql + "        INSERT INTO" + "        	C_POC_EMAIL_USER" + "        	("
        + "				C_POC_EMAIL_USER_ID, " + "				AD_CLIENT_ID ," + "				AD_ORG_ID ," + "				ISACTIVE ,"
        + "				CREATED ," + "				CREATEDBY, " + "				UPDATED ," + "				UPDATEDBY, "
        + "				ADDRESS_TYPE," + "				C_POC_EMAIL_ID ," + "				AD_USER_ID" + "        	)"
        + "        	VALUES" + "        	(" + "        		TO_NUMBER(?)," + "        		TO_NUMBER(?),"
        + "        		TO_NUMBER(?), " + "        		'Y', " + "        		now(), "
        + "        		TO_NUMBER(?)," + "				now()," + "				TO_NUMBER(?)," + "				TO_NUMBER(?),"
        + "				TO_NUMBER(?)," + "				TO_NUMBER(?)" + "			)";
    ...
    try {
      st = connectionProvider.getPreparedStatement(conn, strSql);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, bmPocEmailUserId);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, adClientId);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, adOrgId);
      ...
      UtilSql.setValue(st, iParameter, 12, null, bmPocEmailId);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, email_adUserId);
  ...
  public static String getSenderAddress(ConnectionProvider connectionProvider, String adClientId,
