...
public final class AcctSchema implements Serializable {
  ...
  public AcctSchema(ConnectionProvider conn, String C_AcctSchema_ID) {
    ...
    m_DueFrom_Acct = null;
    m_elementList = null;
    m_CurrencyBalancingLoss_Costcenter_ID = "";
    ...
    try {
      ...
      if (data.length == 1) {
        ...
        {  // era
          ...
          ID = data[0].currencybalancinglossAcct;
          m_CurrencyBalancingLoss_Acct = Account.getAccount(conn, ID);
          m_CurrencyBalancingLoss_Costcenter_ID = data[0].currencybalancinglossCostcenterId;
  ...
  public Account getCurrencyBalancingLoss_Acct() {
	    return m_CurrencyBalancingLoss_Acct;
	  } 
  
  public String getCurrencyBalancingLoss_Costcenter_ID(){
    return m_CurrencyBalancingLoss_Costcenter_ID;
  }
  ...
  public Account m_CurrencyBalancingLoss_Acct;
  public Account m_DueTo_Acct;
  public Account m_DueFrom_Acct;
  ArrayList<Object> m_elementList;
  
  public String m_CurrencyBalancingLoss_Costcenter_ID;
