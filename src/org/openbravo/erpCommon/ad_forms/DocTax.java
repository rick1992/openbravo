...
public class DocTax {
  ...
  public static final int ACCTTYPE_Man_TaxDue_Trans = 7;

  public static final int ACCTTYPE_Man_TaxCredit_Trans = 8;
    ...
    try {
      ...
      if (data.length > 0) {
        ...
        case 6:
          ...
          break;
        case 7:
          validCombination_ID = data[0].emScoTManDueTransAcct;
          break;
        case 8:
          validCombination_ID = data[0].emScoTManCredTransAcct;
          break;
        }
      }
