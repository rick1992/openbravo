...
public class ReporteDetraccionVentasJR extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strStartDate = vars.getGlobalVariable("inpStartDate",
          "ReporteDetraccionVentasJR|startDate", SREDateTimeData.today(this));
      String strEndDate = vars.getGlobalVariable("inpEndDate", "ReporteDetraccionVentasJR|endDate",
          SREDateTimeData.tomorrow(this));
      String strAD_Org_ID = vars.getGlobalVariable("inpadOrgId",
          "ReporteDetraccionVentasJR|AD_Org_ID", "");
  ...
  private void printPage(HttpServletRequest request, HttpServletResponse response,
    ...
    ReporteDetraccionVentasJRData[] data = null;

    try {
      data = ReporteDetraccionVentasJRData.select(vars.getSessionValue("#AD_CLIENT_ID"),
    ...
    String strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/Rpt_DetraccionVentas_ugo.jrxml";
    ...
    if (data != null) {
      renderJR(vars, response, strReportName, "ReporteDetraccionVentas", "pdf", parameters, data,
          null);
    }
  ...
  private void printPageDataSheet(HttpServletRequest request, HttpServletResponse response,
    ...
    if (data == null || data.length == 0) {
      xmlDocument = xmlEngine.readXmlTemplate(
          "pe/com/unifiedgo/report/ad_reports/ReporteDetraccionVentasFilterJR", discard)
          .createXmlDocument();
      data = ReporteDetraccionVentasJRData.set();
      data[0].rownum = "0";
    } else {
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReporteDetraccionVentasFilterJR",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "pe.com.unifiedgo.report.ad_reports.ReporteDetraccionVentasJR");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
          "ReporteDetraccionVentasFilterJR.html", classInfo.id, classInfo.type, strReplaceWith,
          tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
          "ReporteDetraccionVentasFilterJR.html", strReplaceWith);
      xmlDocument.setParameter("leftTabs", lBar.manualTemplate());
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
    {
      OBError myMessage = vars.getMessage("ReporteDetraccionVentasJR");
      vars.removeMessage("ReporteDetraccionVentasJR");
      if (myMessage != null) {
