...
public class SL_Journal_Period extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      try {
        printPage(response, vars, strDateAcct, strDateDoc, strcPeriodId, strWindowId, strChanged, strTabId, strCurrencyId, strAcctSchemaId, strCurrencyRateType);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strDateAcctNew, String strDateDocNew, String strcPeriodIdNew, String strWindowId, String strChanged, String strTabId, String strCurrencyId, String strAcctSchemaId, String strCurrencyRateType) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
    ...
    try {
      currencyRate = SLJournalPeriodData.getCurrencyRate(this, strCurrencyId, acctSchema.getCurrency().getId(), strDateAcctNew, strCurrencyRateType, stradClientId, stradOrgId, strAcctSchemaId);
    } catch (Exception e) {
