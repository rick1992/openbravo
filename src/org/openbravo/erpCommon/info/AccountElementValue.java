  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      if (strAcctSchema.equals("")) {
        ...
        vars.setSessionValue("$C_AcctSchema_ID", strAcctSchema);
      String strValue2 = vars.getGlobalVariable("inpValue", "AccountElementValue.value", "");
      String strName2 = vars.getGlobalVariable("inpName", "AccountElementValue.name", "");
      String strValue = vars.getStringParameter("inpValue");
//      strValue=strValue.compareToIgnoreCase("")==0?strValue2:strValue;
      String strName = vars.getStringParameter("inpName");
//      strName=strName.compareToIgnoreCase("")==0?strName2:strName;
