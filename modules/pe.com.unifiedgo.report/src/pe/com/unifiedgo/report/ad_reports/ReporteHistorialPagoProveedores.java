...
public class ReporteHistorialPagoProveedores extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocDate = vars.getGlobalVariable("inpDocDate",
          "ReporteHistorialPagoProveedores|docDate", SREDateTimeData.today(this));
      String strProyDate = vars.getGlobalVariable("inpProyDate",
          "ReporteHistorialPagoProveedores|proyDate", SREDateTimeData.tomorrow(this));
      String strAD_Org_ID = vars.getGlobalVariable("inpadOrgId",
          "ReporteHistorialPagoProveedores|AD_Org_ID", "");
      String strcBpartnetId = vars.getGlobalVariable("inpcBPartnerId",
          "ReporteHistorialPagoProveedores|CB_PARTNER_ID", "");
      String strcPeriodId = vars.getGlobalVariable("inpPeriodo",
          "ReporteHistorialPagoProveedores|C_PERIOD_ID", "");
      System.out.println("defaul " + strcPeriodId);
      ...
      System.out.println("edit " + strcPeriodId);
      ...
      String strDocDate = vars.getRequestGlobalVariable("inpDocDate",
          "ReporteHistorialPagoProveedores|docDate");
      String strProyDate = vars.getRequestGlobalVariable("inpProyDate",
          "ReporteHistorialPagoProveedores|proyDate");
      String strAD_Org_ID = vars.getGlobalVariable("inpadOrgId",
          "ReporteHistorialPagoProveedores|AD_Org_ID", "0");
      String strcBpartnetId = vars.getGlobalVariable("inpcBPartnerId",
          "ReporteHistorialPagoProveedores|CB_PARTNER_ID", "");
      String strcPeriodId = vars.getGlobalVariable("inpPeriodo",
          "ReporteHistorialPagoProveedores|C_PERIOD_ID", "");

      System.out.println("PDF " + strcPeriodId);

      setHistoryCommand(request, "DEFAULT");

      if (vars.commandIn("PDF")) {
        printPagePDF(request, response, vars, strDocDate, strProyDate, strcBpartnetId,
            strcPeriodId, strAD_Org_ID);
      } else {
        printPageXLS(response, vars, strDocDate, strProyDate, strcBpartnetId, strAD_Org_ID);
      }
    } else {
      pageError(response);
    }
  ...
  private void printPagePDF(HttpServletRequest request, HttpServletResponse response,
      ...
      String strcPeriodId, String strAD_Org_ID) throws IOException, ServletException {

    ReporteHistorialPagoProveedoresData[] data = null;

    try {
      data = ReporteHistorialPagoProveedoresData.select(strAD_Org_ID,
          vars.getSessionValue("#AD_CLIENT_ID"), strDocDate, strProyDate, strcBpartnetId,
          vars.getSessionValue("#AD_USER_ID"), vars.getSessionValue("#AD_LANGUAGE"));
    } catch (OBException e) {
    ...
    if (data == null) {
      advisePopUp(request, response, "WARNING",
          Utility.messageBD(this, "ProcessStatus-W", vars.getLanguage()),
          Utility.messageBD(this, "FINPR_NoConversionFound", vars.getLanguage()) + " " + strDocDate
              + " - " + strProyDate);
    }
    ...
    if (vars.commandIn("PDF")) {
      strOutput = "pdf";
      strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteHistorialPagoProveedores.jrxml";
    } else {
      strOutput = "xls";
      strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteHistorialPagoProveedoresExcel.jrxml";
    }
    HashMap<String, Object> parameters = new HashMap<String, Object>();

    parameters.put("ORGANIZACION",
        ReporteHistorialPagoProveedoresData.selectOrganization(this, strAD_Org_ID));
    parameters.put("RUC_ORGANIZACION",
        ReporteHistorialPagoProveedoresData.selectRucOrganization(this, strAD_Org_ID));
    parameters.put("TERCERO",
        ReporteHistorialPagoProveedoresData.selectBPartner(this, strcBpartnetId));
    parameters
        .put("PERIODO", ReporteHistorialPagoProveedoresData.selectPeriodo(this, strcPeriodId));
    parameters.put("DESDE", StringToDate(strDocDate));
    parameters.put("HASTA", StringToDate(strProyDate));

    // parameters.put("LANGUAGE", vars.getSessionValue("#AD_LANGUAGE"));

    renderJR(vars, response, strReportName, "Reporte_Historial_Pago_a_Proveedores", "pdf",
  ...
  private void printPageXLS(HttpServletResponse response, VariablesSecureApp vars,
    ...
    parameters.put("RUC_ORGANIZACION",
        ReporteHistorialPagoProveedoresData.selectRucOrganization(this, strAD_Org_ID));
    parameters.put("TERCERO",
        ReporteHistorialPagoProveedoresData.selectBPartner(this, strAD_Org_ID));
    parameters
        .put("PERIODO", ReporteHistorialPagoProveedoresData.selectPeriodo(this, strAD_Org_ID));
    parameters.put("DESDE", StringToDate(strDocDate));
    parameters.put("HASTA", StringToDate(strProyDate));

    renderJR(vars, response, strReportName, "Reporte_Hitorial_Pago_Proveedores", "xls", parameters,
        data, null);
  }
  ...
  private void printPageDataSheet(HttpServletRequest request, HttpServletResponse response,
    ...
    xmlDocument = xmlEngine.readXmlTemplate(
        "pe/com/unifiedgo/report/ad_reports/ReporteHistorialPagoProveedores", discard)
        .createXmlDocument();
    ...
    if (vars.commandIn("EDIT_HTML", "EDIT_PDF")) {
      ...
      if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
        ...
        if (data == null || data.length == 0) {
          ...
          data = ReporteHistorialPagoProveedoresData.set();
        } else {
    ...
    if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      ...
      ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReporteHistorialPagoProveedores",
      ...
      try {
        WindowTabs tabs = new WindowTabs(this, vars,
            "pe.com.unifiedgo.report.ad_reports.ReporteHistorialPagoProveedores");
        xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
        xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
        xmlDocument.setParameter("childTabContainer", tabs.childTabs());
        xmlDocument.setParameter("theme", vars.getTheme());
        NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
            "ReporteHistorialPagoProveedores.html", classInfo.id, classInfo.type, strReplaceWith,
            tabs.breadcrumb());
        xmlDocument.setParameter("navigationBar", nav.toString());
        LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
            "ReporteHistorialPagoProveedores.html", strReplaceWith);
        xmlDocument.setParameter("leftTabs", lBar.manualTemplate());
      } catch (Exception ex) {
        throw new ServletException(ex);
      }
      {
        OBError myMessage = vars.getMessage("ReporteHistorialPagoProveedores");
        vars.removeMessage("ReporteHistorialPagoProveedores");
        if (myMessage != null) {
      ...
      try {
        ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "AD_Org_ID", "",
            "0C754881EAD94243A161111916E9B9C6", Utility.getContext(this, vars,
                "#AccessibleOrgTree", "ReporteHistorialPagoProveedores"), Utility.getContext(this,
                vars, "#User_Client", "ReporteHistorialPagoProveedores"), 0);
        Utility.fillSQLParameters(this, vars, null, comboTableData,
            "ReporteHistorialPagoProveedores", strAD_Org_ID);
        xmlDocument.setData("reportAD_Org_ID", "liststructure", comboTableData.select(false));
        comboTableData = null;

        ReporteHistorialPagoProveedoresData[] datax = ReporteHistorialPagoProveedoresData
        ...
        xmlDocument.setParameter("paramPeriodosArray", Utility.arrayInfinitasEntradas(
            ...
            ReporteHistorialPagoProveedoresData.select_periodos(this)));

        // System.out.println(Utility.arrayInfinitasEntradas(
        // "idperiodo;periodo;fechainicial;fechafinal", "arrPeriodos",
        // ReporteHistorialPagoProveedoresData.select_periodos(this)));
