...
public class ReporteSeguimientoVisitas extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      /**/
      String strAD_Org_ID = vars.getGlobalVariable("inpOrgId", "ReporteSeguimientoVisitas|OrgId",
          "");
      ...
      //if (vars.commandIn("XLS")) {
        printPageXLS(request, response, vars, strAD_Org_ID, strDateFrom, strDateTo, strSalesRepId, strCProjectId);
      //}
  ...
  private void printPageXLS(HttpServletRequest request, HttpServletResponse response,
    ...
    ReporteSeguimientoVisitasData[] data = null;

    try {
      data = ReporteSeguimientoVisitasData.selectData(this, strAD_Org_ID, strDateFrom, strDateTo,
    		  strCProjectId, strSalesRep);
    } catch (OBException e) {
    ...
    if(vars.commandIn("PDF")){
    	strOutput = "pdf";
        strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteSeguimientoVisitas.jrxml";
    }else{
    	strOutput = "xls";
        strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/ReporteSeguimientoVisitasExcel.jrxml";
    }

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    String orgname = ReporteSeguimientoVisitasData.selectOrg(this, strAD_Org_ID).toString();

    /* parameters */
    parameters.put("ORGANIZACION", orgname);
    parameters.put("RUC", ReporteSeguimientoVisitasData.selectRuc(this, strAD_Org_ID));

    parameters.put("strDateFrom", strDateFrom);
    parameters.put("strDateTo", strDateTo);

    renderJR(vars, response, strReportName, "Reporte_Seguimiento_Visitas", strOutput, parameters,
        data, null);
  }
  ...
  private void printPageDataSheet(HttpServletRequest request, HttpServletResponse response,
      ...
      String strSalesRepId, String strcProjectId) throws IOException, ServletException {
    ...
    ReporteSeguimientoVisitasData[] dataItems = null;
    ...
    xmlDocument = xmlEngine.readXmlTemplate(
        "pe/com/unifiedgo/report/ad_reports/ReporteSeguimientoVisitas", discard)
        .createXmlDocument();
    ...
    if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      ...
      ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReporteSeguimientoVisitas", false,
      ...
      try {
        WindowTabs tabs = new WindowTabs(this, vars,
            "pe.com.unifiedgo.report.ad_reports.ReporteSeguimientoVisitas");
        xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
        xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
        xmlDocument.setParameter("childTabContainer", tabs.childTabs());
        xmlDocument.setParameter("theme", vars.getTheme());
        NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
            "ReporteSeguimientoVisitas.html", classInfo.id, classInfo.type, strReplaceWith,
            tabs.breadcrumb());
        xmlDocument.setParameter("navigationBar", nav.toString());
        LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
            "ReporteSeguimientoVisitas.html", strReplaceWith);
...
//      try {
//        dataItems = ReporteSeguimientoVisitasData.getGlItems(this, strAD_Org_ID);
//
...
//        		  ReporteSeguimientoVisitasData.getGlItems(this, strAD_Org_ID)));

      /* FIN Llenar controles */

      {
        OBError myMessage = vars.getMessage("ReporteSeguimientoVisitas");
        vars.removeMessage("ReporteSeguimientoVisitas");
        if (myMessage != null) {
