...
if (!isc.Page.isRTL()) {
  isc.OBSelectorWidget.addClassProperties({
    fieldPickerIconSrc: OB.Styles.skinsPath + 'Default/org.openbravo.client.application/images/form/search_picker.png'
  });
} else {
  isc.OBSelectorWidget.addClassProperties({
...
isc.OBSelectorWidget.addClassProperties({
  styling: {
    ...
    fieldPickerIconWidth: 21,
    fieldPickerIconHeight: 21,
