...
public class RankingClientesJR extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocDate = vars.getGlobalVariable("inpDocDate", "RankingClientesJR|docDate",
          SREDateTimeData.today(this));
      String strProyDate = vars.getGlobalVariable("inpProyDate", "RankingClientesJR|proyDate",
          SREDateTimeData.tomorrow(this));
      String strAD_Org_ID = vars.getGlobalVariable("inpOrgId", "RankingClientesJR|OrgId", "");
//      String strCurrencyId = vars.getGlobalVariable("inpCurrencyId", "RankingClientesJR|currency",
//          strUserCurrencyId);
      String strSalesRepId = vars.getGlobalVariable("inpSalesRepId",
          "RankingClientesJR|SalesRep_ID", "");
...
//          strUserCurrencyId);
      ...
      String strCurrencyId = "308";//vars.getGlobalVariable("inpCurrencyId", "RankingClientesJR|currency");
      String strSalesRepId = vars.getStringParameter("inpSalesRepId");
  ...
  private void printPageXLS(HttpServletRequest request, HttpServletResponse response,
      ...
      String strCurrencyId, String strSalesRepId) throws IOException, ServletException {

    RankingClientesJRData[] data = null;

    try {
      data = RankingClientesJRData.select(vars, strAD_Org_ID,
          vars.getSessionValue("#AD_CLIENT_ID"), strDocDate, strProyDate,
          vars.getSessionValue("#AD_USER_ID"), strSalesRepId);
    } catch (OBException e) {
    ...
    {
    	data[i].totalpenlinenetamt=quitaComma(data[i].totalpenlinenetamt);
    	data[i].totalpenqtyinvoiced=quitaComma(data[i].totalpenqtyinvoiced);
    	data[i].totalusdlinenetamt=quitaComma(data[i].totalusdlinenetamt);
    	data[i].totalusdqtyinvoiced=quitaComma(data[i].totalusdqtyinvoiced);
    }
    ...
    strReportName = "@basedesign@/pe/com/unifiedgo/report/ad_reports/RankingClientesExcel.jrxml";

    HashMap<String, Object> parameters = new HashMap<String, Object>();

    parameters.put("ORGANIZACION", RankingClientesJRData.selectOrganization(this, strAD_Org_ID));
    parameters.put("MONEDA", RankingClientesJRData.selectCurrency(this, strCurrencyId));
    ...
    renderJR(vars, response, strReportName, "Reporte_Ranking_Clientes", strOutput, parameters,
        data, null);
  }
  ...
  private void printPageDataSheet(HttpServletRequest request, HttpServletResponse response,
      VariablesSecureApp vars, String strDocDate, String strProyDate, String strAD_Org_ID,
      String strSalesRepId, boolean isFirstLoad) throws IOException,
      ServletException {
    if (log4j.isDebugEnabled())
    ...
    xmlDocument = xmlEngine.readXmlTemplate(
        "pe/com/unifiedgo/report/ad_reports/RankingClientesFilterJR", discard).createXmlDocument();
    ...
    if (vars.commandIn("EDIT_HTML", "EDIT_PDF")) {
      ...
      if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
        ...
        if (data == null || data.length == 0) {
          ...
          data = RankingClientesJRData.set();
        } else {
    ...
    if (strConvRateErrorMsg.equals("") || strConvRateErrorMsg == null) {
      ...
      ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "RankingClientesFilterJR", false, "",
      ...
      try {
        WindowTabs tabs = new WindowTabs(this, vars,
            "pe.com.unifiedgo.report.ad_reports.RankingClientesJR");
      ...
      {
        OBError myMessage = vars.getMessage("RankingClientesJR");
        vars.removeMessage("RankingClientesJR");
        if (myMessage != null) {
...
//        Utility.fillSQLParameters(this, vars, null, comboTableData, "RankingClientesFilterJR",
//            strCurrencyId);
...
//      }
      ...
      xmlDocument.setParameter("paramSalesRepDescription",
          RankingClientesJRData.selectSalesRepresentative(this, strSalesRepId));
