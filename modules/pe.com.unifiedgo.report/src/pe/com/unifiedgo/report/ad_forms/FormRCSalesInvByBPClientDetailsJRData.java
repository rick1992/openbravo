...
class FormRCSalesInvByBPClientDetailsJRData implements FieldProvider {
  static Logger log4j = Logger.getLogger(FormRCSalesInvByBPClientDetailsJRData.class);
  ...
  public static Vector<RCSalesInvoiceByBPData> getData(String adOrgId, String adClientId,
      String adUserId, String strSalesRepID, String startDate, String endDate, String strBPClientId)
      throws ServletException {
    Vector<RCSalesInvoiceByBPData> so_vector = new Vector<RCSalesInvoiceByBPData>(0);
    int BigDecimalScale = 5;

    String strSql = "";
    strSql = "SELECT i.c_invoice_id, i.em_scr_physical_documentno, i.dateacct, "
        + "          sum(CASE WHEN i.em_sco_specialdoctype='SCOARCREDITMEMO' THEN -il.linenetamt ELSE il.linenetamt END) as totallinenetamt, "
        ...
        + "          (select (name) from ad_org where ad_org.ad_org_id=i.ad_org_id) as organizacion "
        + "     FROM c_invoice i "
        ...
        + "    AND i.c_bpartner_id = '" + strBPClientId + "'  ";
    strSql = strSql
    ...
    strSql = strSql
        ...
        + adClientId
        + "') <> -1"
        + "     GROUP BY i.c_invoice_id, i.dateacct, i.poreference, dttrl.name, i.c_currency_id, i.c_bpartner_id, i.c_order_id,"
        + "              i.ad_org_id, i.em_scr_physical_documentno, i.salesrep_id "
    ...
    try {
      ...
      for (int k = 0; k < data.size(); k++) {
        ...
        RCSalesInvoiceByBPData soData = new RCSalesInvoiceByBPData();
  ...
  public static FormRCSalesInvByBPClientDetailsJRData[] select(VariablesSecureApp vars,
      String adOrgId, String adClientId, String adUserId, String strSalesRepID, String dateFrom,
      String dateTo, String strBPClientId) throws ServletException {
    return select(vars, adOrgId, adClientId, adUserId, strSalesRepID, dateFrom, dateTo,
        strBPClientId, 0, 0);
  }

  public static FormRCSalesInvByBPClientDetailsJRData[] select(VariablesSecureApp vars,
      String adOrgId, String adClientId, String adUserId, String strSalesRepID, String dateFrom,
      String dateTo, String strBPClientId, int firstRegister, int numberRegisters)
      throws ServletException {
    ...
    Vector<RCSalesInvoiceByBPData> data = getData(adOrgId, adClientId, adUserId, strSalesRepID,
        dateFrom, dateTo, strBPClientId);
    for (int k = 0; k < data.size(); k++) {
      countRecord++;

      FormRCSalesInvByBPClientDetailsJRData objSODetail = new FormRCSalesInvByBPClientDetailsJRData();
    ...
    FormRCSalesInvByBPClientDetailsJRData objSODetail[] = new FormRCSalesInvByBPClientDetailsJRData[vector
        .size()];
  ...
  public static FormRCSalesInvByBPClientDetailsJRData[] set() throws ServletException {
    FormRCSalesInvByBPClientDetailsJRData objSODetail[] = new FormRCSalesInvByBPClientDetailsJRData[1];
    objSODetail[0] = new FormRCSalesInvByBPClientDetailsJRData();
    ...
    objSODetail[0].codcliente = "--";
    objSODetail[0].descliente = "--";
    objSODetail[0].organizacion = "--";

    return objSODetail;
  }
}

class RCSalesInvoiceByBPData {
  public String documentno;
  public String documentid;
